...
【適用版本】企業版
【來源連結】https://www.cyberbiz.io/support/?p=36980
...
1. **【後台路徑】管理 → 資料收集與修改 → 資料串流 → 選擇串流 → 事件 → 加強型評估**[[圖片說明：google-analytics-：串接教學11-1024x486]](https://www.cyberbiz.io/support/wp-content/uploads/Google-Analytics-：串接教學11.png)
...
1. **【後台路徑】管理 → 資源設定 → 資料收集與修改 → 資料保留**[](https://www.cyberbiz.io/support/wp-content/uploads/GA4-進階資料分析設定01.png)
