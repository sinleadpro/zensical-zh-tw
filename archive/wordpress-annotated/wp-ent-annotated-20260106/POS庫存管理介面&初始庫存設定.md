【文件標題】POS庫存管理介面&初始庫存設定
【適用版本】企業版
【來源連結】https://www.cyberbiz.io/support/?p=27443
【章節路徑】POS庫存管理介面&初始庫存設定
...
[[圖片說明：POS庫存管理]](https://www.cyberbiz.io/support/wp-content/uploads/POS庫存管理介面說明1.png)

- 若為EC庫存管理，需至「POS功能」→「EC/POS庫存管理」中作庫存調整。
若為POS庫存，需至「所有POS商店」→欲調整POS店的「庫存管理」中作庫存調整。
PS：僅店長可進行庫存管理，店員無此權限。

[[圖片說明：POS庫存管理]](https://www.cyberbiz.io/support/wp-content/uploads/POS庫存管理介面說明2.png)
POS庫存管理介面說明 EC庫存【後台路徑】POS功能→「EC/POS庫存管理」
POS庫存【後台路徑】POS功能→「所有POS商店」→庫存管理

- 此圖以EC為例

[[圖片說明：POS庫存管理]](https://www.cyberbiz.io/support/wp-content/uploads/POS庫存管理介面說明3.png)
...
[[圖片說明：POS庫存管理]](https://www.cyberbiz.io/support/wp-content/uploads/POS庫存管理介面說明6.png)