【文件標題】POS身份權限設定
【適用版本】企業版
【來源連結】https://www.cyberbiz.io/support/?p=3168
【章節路徑】POS身份權限設定
...
[[圖片說明：POS身份權限設定]](https://www.cyberbiz.io/support/wp-content/uploads/POS身份權限設定1.png)
...
2. 勾選欲加入身份員工
3. 將員工加入身份
[[圖片說明：POS身份權限設定]](https://www.cyberbiz.io/support/wp-content/uploads/POS身份權限設定2.png)
...
[圖片說明：image-12]
**2.建立員工身份** **2-1.輸入身份名稱** 舉例:副店長 [圖片說明：image-2] **2-2.勾選「由其他身份複製」
2-3.選擇要複製的身份** [圖片說明：image-3] [圖片說明：image-4-1024x856]
**2-4.點擊「建立」，完成身份建立。(2-2、2-3亦可跳過)** [圖片說明：image-6] **二、設定(編輯)身份權限**
**1.****點選設定身份權限下方的選單，可展開找到剛建立完的身份。** [圖片說明：image-7-1024x937]
**2.****選取剛設好的身份後，即可看見該身份預設有的權限。** [圖片說明：image-8-1024x943] **3\. 勾掉「所有權限」，可編輯此身份擁有的權限功能。**
[圖片說明：image-9-1024x410] **4\.
選取完權限後，點選「更新身分」即完成身份權限編輯。** [圖片說明：image-10-1024x561] **5.權限功能說明** **POS基本權限** POS前台
...
[圖片說明：image-18-1024x475]
**2.選擇身分後，將跳出所有管理員列表。可指定帳號並移至右方完成身分指派。**
[圖片說明：image-19-1024x568] \-->