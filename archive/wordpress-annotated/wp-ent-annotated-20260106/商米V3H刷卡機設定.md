【文件標題】商米V3H刷卡機設定
【適用版本】企業版
【來源連結】https://www.cyberbiz.io/support/?p=51450
【章節路徑】商米V3H刷卡機設定
...
📌 設備認識與MYPAY金流設定
使用商米V3H刷卡機，只需要有Wifi，不需接線就可以完成付款和列印發票，適合搭配平板使用，請參考[平板模式教學文件](https://www.cyberbiz.io/support/?p=21520\(在新分頁中開啟\))。使用此款刷卡機，必須使用MyPay的金流服務。
[圖片說明：sunmi_v3h_handheld_pos_terminal_back] ☝️ **前置步驟**
...
- 請輸入：[您的統編]_01
- 例如：12345678_01
[圖片說明：sharex_2025-07-22_13-46-43]
...
[圖片說明：sharex_2025-11-25_17-22-33] 2.
...
1. 開啟MyPay APP
2. 輸入商店資料登入
[[圖片說明：商米P2-PRO刷卡機設定01]](https://www.cyberbiz.io/support/wp-content/uploads/2021/11/商米P2-PRO刷卡機設定01.png) ☝️ **結帳**
...
adaptive="yes" spacing="yes" align="none" max_width="none" captions="no"
arrows="yes" dots="yes" link="lightbox" target="blank" autoplay="5"
speed="medium" image_size="medium" class=""]  📌 紙捲廠商資訊
若您自CYBERBIZ購買商米V3H，機器將內附上一捲紙捲，紙捲用完前，請您至[財政部電子發票感熱紙](https://invoice.ppmof.gov.tw/PSJ_Web/)添購，規格為10m公版感熱紙捲，寬度5.7cm，紙捲長度10m，外徑約3.6cm。
[圖片說明：發票紙捲2]
[圖片說明：發票紙捲]