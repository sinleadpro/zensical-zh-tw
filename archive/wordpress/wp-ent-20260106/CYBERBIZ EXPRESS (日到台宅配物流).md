---
title: "CYBERBIZ EXPRESS (日到台宅配物流)"
last_modified: ""
categories: [常見問題]
tags: []
permalink: "https://www.cyberbiz.io/support/?p=51481"
id: "51481"
---

![](https://www.cyberbiz.io/support/wp-content/uploads/適用站別.png)
![](https://www.cyberbiz.io/support/wp-content/uploads/日到台.png) **看了此文件，您可以：**  

* **了解日到台宅配物流的開通信件與設定流程，** 包含合約同意、基本資料與出貨地址設定。
* **掌握訂單出貨操作步驟，** 能正確建立託運單、下載文件並完成寄件。
* **熟悉補印託運單的條件與操作方式，** 確保出貨文件齊全。
* **查詢託運單配送狀態，** 了解後台與前台可查看的位置與操作方式。
* **查看每筆訂單的預估與實際運費，** 協助進行成本核對與物流費用管理。
**操作目錄：**

* CYBERBIZ EXPRESS 物流規格
* CYBERBIZ EXPRESS 物流運送流程
* 申請開通物流
* 跨境商品設定
* 訂單出貨操作
* 補印託運單
...
* 跨境包裹在報關環節，收件人須執行相符申報作業。商家可主動佈達並指引消費者完成申報流程，以減少包裹等待時間。
📌 CYBERBIZ EXPRESS 物流規格  
CYBERBIZ EXPRESS 為一站式日本跨境直送台灣的物流服務，專為日台電商設計，輕鬆將「日本製產品」送達台灣，成為您進軍台灣市場的橋樑。  

下方為CYBERBIZ EXPRESS服務的物流規格說明：  
規格 | 說明  
---|---  
**付款方式** | 僅支援貨到不付款  
**支援溫層** | 僅支援常溫配送  
**運費計費** | 系統會以商品重量與材積，於建立託運單時自動計算並預扣CYBER幣  
每月5號會依實際收取運費，多退少補CYBER幣  
**交貨模式** | 採用DDU(未完稅交貨)模式，稅金由收件人支付  
**收件方式** | 支援「上門取件」與「商家自行寄至日本倉庫」兩種方式  
實際運費會依合作方案與取件方式不同而有所差異  
📌 CYBERBIZ EXPRESS 物流運送流程  
➊ 收件入庫 → ➋ 理貨集運 → ➌ 航空轉運 → ❹ 海關報關 → ❺ 台灣本地配送  

流程 | 操作說明  
---|---  
**➊ 收件入庫** | 
* 通知物流商前往收件前，請將當天出貨訂單對應的提單清單與報關發票檔案，以 E-mail 寄送至`manifest_express@cyberbiz.io`
* 詳細步驟參考訂單出貨操作  
**➋ 理貨集運** | 
* 集運過程採用併袋配送（將約 20 個包裹合併為一件貨品報關）
* 依海關規定，須袋內所有包裹的消費者皆完成申報相符程序，整批併袋貨物方能獲得海關統一放行
* 申報相符流程可參考 ❹ 海關報關  
**➌ 航空轉運** | 
* 轉運時將依據每週航班排程安排包裹配送作業
* 平均而言，等待航班集運的時間約需 1 至 2 個工作日
* 實際的最終配送時程，則將以該週確認的航班時間為準  
**❹ 海關報關** | 
* 當包裹進入報關階段時，消費者須完成「申報相符」回報，包裹才可放行
* 消費者需下載EZWAY App，並於[EZWAY App點擊「申報相符」](https://web.customs.gov.tw/singlehtml/3150?cntId=cus1_3150_3150_1471)，即回報完成
* 若消費者超過 15 天未完成報關申報作業，海關將自第 16 天起，對收件人收取包裹滯報費每日 NT$200 元
* 若滯報費累積滿20日後，消費者仍未申報，海關有權對貨物進行變賣處置。詳可見 [財政部關務署公告](https://web.customs.gov.tw/singlehtml/1207?cntId=cus1_93451_1207)  
**❺ 台灣本地配送** | 
* 單筆包裹價值若超過NT$2000元，海關可能課徵關稅與相關稅費
* 稅金將由物流商派送包裹時，向收件人收取  
📌 申請開通物流  
