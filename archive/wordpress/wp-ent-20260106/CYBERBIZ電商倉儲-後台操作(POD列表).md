...
● 回單狀態：分為已完成和未完成  
![篩選](https://www.cyberbiz.io/support/wp-content/uploads/CYBERBIZ電商倉儲-後台操作POD列表01.png)
...
* 結果列表：  
點擊訂單編號可進入該張訂單資訊頁。  
![結果列表](https://www.cyberbiz.io/support/wp-content/uploads/CYBERBIZ電商倉儲-後台操作POD列表02.png)
