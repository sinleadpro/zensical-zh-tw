...
10. LINEX 物流僅支援台灣出貨至國外。
11. LINEX 託運單因所需檢查的內容較多，所以不支援批次列印託運單功能，敬請見諒！ 
12. 運送模式「取件預約」、「自行運送」設定後無法進行修改，請商家設定前再三確認。
13. 建議可使用雷射印表機來產出託運單，以避免出貨資訊異常風險。
【取件預約】
...
* 取件資料 : 依照取件人資料填寫。(英文)
* 取件備註 : 為必填不能為空值。
*實際取件時間需依 LINEX 當日派車狀況為主，請留意 LINEX 通知  ![取件預約功能](https://www.cyberbiz.io/support/wp-content/uploads/LINEX-物流開通設定07.png)
