...
*[PLUS版以上]: 專業PLUS版、進階PLUS版、高手PLUS版、企業版。
...
*[SERP]: Search Engine Results Page，中文全稱為「搜尋引擎結果頁」。 這是使用者在 Google、Bing 或其他搜尋引擎輸入特定關鍵字（如「根本Original」）並按下搜尋後，所看到的結果清單畫面。
...
*[圖片替代文字]: 網頁上針對圖片所寫的簡短文字描述。它隱藏在網頁程式碼中，主要用途是在圖片因網路問題無法顯示時替代出現，或是由「螢幕閱讀器」朗讀給視障朋友聽。此外，它也能幫助 Google 等搜尋引擎看懂圖片內容，進而提升網站的搜尋排名。
...
*[預購商品]: 當商品庫存歸零時，若將「庫存不足時的處理」設為繼續銷售，該商品即可持續接受顧客下單，達到預購模式的效果，無需另建商品類型。
...
*[高手版以上]: 高手版、專業PLUS版、進階PLUS版、高手PLUS版、企業版。
*[進階方案以上]: 進階、高手、專業PLUS、進階PLUS、高手PLUS、企業方案。
*[RWD]: Responsive Web Design，響應式網頁設計，讓網站能自動適應不同裝置的螢幕尺寸（桌機、平板、手機），提供一致且易於閱讀的操作體驗。
*[ERP]: Enterprise Resource Planning，企業資源規劃系統。用於整合與管理企業內部各項營運流程（如財務、庫存、採購、生產等）的資訊系統，可與 CYBERBIZ 進行資料串接，實現訂單、商品與庫存資訊的自動同步。
