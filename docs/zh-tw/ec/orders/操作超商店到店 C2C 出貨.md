...
!!! info "一般版 商家請先 [儲值 CYBER 幣](#)(管理中心 > 儲值中心)，若儲值金額不足將無法列印託運單。PLUS / 企業版 商家無需手動儲值，系統將依每期對帳單收取 CYBERB 幣。"
...
> 7-ELEVEN 與全家提供官方寄件流程及包材販售服務，請參考官方網站說明
...
!!! note "顧客未取件處理流程"
	...
	graph LR
	    ...
	    B[2. 啟動退回物流<br>包裹轉送至原寄件門市<br>（1-3 天）] --> C;
	    C[3. 商家取件<br>前往原寄件門市領回包裹] --> D;
	    D[4. 領回期限執行] --> E;
	    E{商家是否於期限內領回？};
	    E -- 是 --> F(流程結束<br>包裹已領回)
	    E -- 否 --> G(包裹銷毀)
