...
!!! warning "注意事項" 
    若您要投放 Google 自動化廣告，請直接在自動化廣告設定頁創建 [CYBERBIZ 代管 GMC 帳號](../../../ec/integrations/google/automated-ads-system.md#cyberbiz-代管適合新手)並設定廣告，無須另外自行申請 GMC 帳號。如此可避免因人員操作 GMC 帳號造成權限變更造成廣告投遞異常。
...
!!! info "含有 `贈品` 跟 `排除product feed` 標籤的商品亦不會出現在 Google 搜尋結果中。瞭解解更多[排除標籤相關設定](../../../ec/products/categories-and-tags/manage-product-tags.md#排除上傳至第三方平台標籤)。"
...
- [排除標籤相關設定](../../../ec/products/categories-and-tags/manage-product-tags.md#排除上傳至第三方平台標籤)
