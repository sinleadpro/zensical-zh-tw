...
-   :lucide-list-checks: __任選折扣__
    ...
    [:octicons-arrow-right-24: 前往](mix-and-match-discounts.md)
...
-   :lucide-palette: __紅配綠多組合優惠__
    ...
    [:octicons-arrow-right-24: 前往](red-and-green-bundle-discounts.md)
...
-   :lucide-gift: __滿額贈 / 滿件贈__
    ...
    [:octicons-arrow-right-24: 前往](threshold-gifts-and-quantity-gifts.md)
...
-   :lucide-package-plus: __設定商品加價購__
    ...
    [:octicons-arrow-right-24: 前往](setup-product-upsell.md)
...
-   :lucide-coins: __設定紅利點數__
    ...
    [:octicons-arrow-right-24: 前往](setup-bonus-points.md)
...
-   :lucide-store: __紅利商城 (EC)__
    ...
    [:octicons-arrow-right-24: 前往](bonus-point-mall.md)
...
-   :lucide-user-plus: __設定註冊禮__
    ...
    [:octicons-arrow-right-24: 前往](setup-registration-gift.md)
...
-   :lucide-cake: __設定生日禮__
    ...
    [:octicons-arrow-right-24: 前往](setup-birthday-gift.md)
...
-   :lucide-sparkles: __期間限定首購禮__
    ...
    [:octicons-arrow-right-24: 前往](limited-time-first-purchase-gift.md)
...
-   :lucide-tags: __指定商品送優惠券__
    ...
    [:octicons-arrow-right-24: 前往](send-coupons-for-specific-products.md)
...
-   :lucide-coins: __指定商品送紅利__
    ...
    [:octicons-arrow-right-24: 前往](send-bonus-points-for-specific-products.md)
...
-   :lucide-credit-card: __指定金流送紅利__
    ...
    [:octicons-arrow-right-24: 前往](send-bonus-points-for-specific-payment-methods.md)
...
-   :lucide-truck: __指定物流送紅利__
    ...
    [:octicons-arrow-right-24: 前往](send-bonus-points-for-specific-logistics.md)
...
-   :lucide-qr-code: __指定商品送活動序號__
    ...
    [:octicons-arrow-right-24: 前往](send-event-serials-for-specific-products.md)
...
-   :lucide-package-minus: __設定商品限購數量__
    ...
    [:octicons-arrow-right-24: 前往](purchase-limit.md)
...
-   :lucide-bell: __優惠券（碼）與紅利點數到期通知__
    ...
    [:octicons-arrow-right-24: 前往](coupon-and-bonus-points-expiry-notification.md)
...
-   :lucide-window: __一頁式商店__
    ...
    [:octicons-arrow-right-24: 前往](one-page-store.md)
...
-   :lucide-video: __設定一頁式商店 YouTube 影片自動播放與起始秒數__
    ...
    [:octicons-arrow-right-24: 前往](one-page-store-youtube-autoplay.md)
...
-   :lucide-link: __建立含指定商品的購物車連結__
    ...
    [:octicons-arrow-right-24: 前往](create-cart-link-specific-products.md)
...
-   :lucide-gamepad-2: __互動遊戲 (EC)__
    ...
    [:octicons-arrow-right-24: 前往](interactive-games.md)
...
-   :lucide-calendar-clock: __定期訂購活動頁__
    ...
    [:octicons-arrow-right-24: 前往](subscription-campaign-page.md)
...
-   :lucide-calculator: __結帳優惠計算順序__
    ...
    [:octicons-arrow-right-24: 前往](checkout-discount-calculation-order.md)
