...
type: quest
intents:
  - adjust storefront product group order
  - set homepage product group display quantity
features:
  - 商品列表群組排序
  - 首頁商品列表顯示數量
tnb: ""
...
audiences:
  - merchant
wp_url:
  - [[archive/wordpress/wp-reg-20260106/群組排序|群組排序]]
  - [[archive/wordpress/wp-ent-20260106/群組排序|群組排序]]
notes:
...
前台首頁的「商品列表」將依照此頁面設定的排序順序，依序顯示商品群組。
