...
last_modified: 2026-06-22 13:52
lang: zh-TW
type: tutorial
status: ""
author: Jase
...
- **日本站特別要求：** 若經營日本站，須另依[日本《特定商取引法》](日本站官網需建立特定商取引法頁面.md)建立專屬頁面，揭露販售業者名稱、負責人、所在地與聯絡方式，並將該頁面連結放入頁腳。
...
- :lucide-list:{ .lg }  
  [__頁腳聯絡資訊欄位對照表__](../references/business-disclosure-footer-fields.md)  
  查看頁腳可顯示的各項聯絡資訊欄位與用途。
