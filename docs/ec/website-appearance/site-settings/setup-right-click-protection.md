...
created: 2025-03-03
last_modified: 2026-06-24 17:32
lang: zh-TW
permalink: ""
type: tutorial
status: ""
...
![網頁鎖右鍵設定](../../../assets/images/ec-網站外觀-樣板編輯器-theme-liquid.png){ title="網頁鎖右鍵設定" .hero-page }
...
![拖拉版型鎖右鍵設定](../../../assets/images/ec-網站外觀-全站設定-網頁鎖右鍵.gif){ title="拖拉版型鎖右鍵設定" }
...
- **放置位置**：
    ...
    === "新版（拖拉介面）"
		...
		![一頁式商店鎖右鍵-新版](../../../assets/images/ec-行銷活動-拖拉版型一頁式商店-網頁鎖右鍵.gif){ title="一頁式商店鎖右鍵-新版" }
    ...
    === "舊版介面"
		...
		![一頁式商店鎖右鍵-舊版](../../../assets/images/ec-行銷活動-舊版一頁式商店-網頁鎖右鍵.gif){ title="一頁式商店鎖右鍵-舊版" }
...
- **恢復機制**：修改程式碼前請先注意，若發生版面異常，可利用編輯器中的 **查看之前版本** 功能，可[回溯至先前版本](../code-customization/restore-code-theme-editor.md#操作步驟){ title="使用樣板編輯器恢復網頁代碼" }。
