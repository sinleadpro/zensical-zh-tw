...
![轉貼連結縮圖設定](../../../assets/images/ec-網站外觀-og-image.png){ title="轉貼連結縮圖設定" .hero-page }
...
![商品頁縮圖設定](../../../assets/images/ec-商品-商品編輯頁-商品圖片-第一張.gif){ title="商品頁縮圖設定" }

---

### 商品群組頁 <small>自訂分類</small>
...
![商品群組縮圖設定](../../../assets/images/ec-網站外觀-商品自訂分類-群組圖片.gif){ title="商品群組縮圖設定" }
...
![部落格文章縮圖](../../../assets/images/ec-網站外觀-部落格文章圖片.gif){ title="部落格文章縮圖" }
...
![FB偵錯工具再次抓取](../../../assets/images/ec-fb-share-debugger-再次抓取.png){ title="FB偵錯工具再次抓取" }
