...
last_modified: 2026-06-12 14:19
lang: zh-TW
type: tutorial
status: ""
version: ""
...
![導覽列-前台](../../../assets/images/ec-網站外觀-套版主題管理-網站設定-導覽列-前台.png)
...
![導覽列-網站logo](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-網站logo.png)
...
![導覽列-導覽列樣式](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-導覽列樣式.png)
...
![導覽列-導覽列字體](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-導覽列字體.png)
...
![導覽列-主要導覽列選單設定](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-主要導覽列選單設定.png)
...
![導覽列-顯示搜尋欄](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-搜尋欄.png)
...
- **公告類型：** 選擇 **圖片公告** 或 **文字公告**。
    ...
    ![導覽列-置頂公告-類型](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-置頂公告.png)

- **公告連結／在新分頁開啟：** 為公告加上點擊連結，可選擇是否於新分頁開啟。
- **上架時間／下架時間：** 設定公告自動顯示與隱藏的時間。
- **顯示時間倒數：** 開啟後於公告顯示倒數計時，並可自訂 **倒數文字顏色** 與 **倒數背景顏色**。

    ![導覽列-置頂公告-細節設定](../../../assets/images/ec-網站外觀-拖拉版型編輯器-導覽列-置頂公告-細節設定.png)
...
![導覽列選單-預設版型](../../../assets/images/ec-網站外觀-網站設定-導覽列選單-預設版型.png)
...
![新增頁腳區塊](../../../assets/images/ec-網站外觀-套版主題管理-網站設定-頁腳-區塊.png)

---

### 頁腳選單 <small>導覽列</small>

> 在設定頁腳的「選單」區塊前，請先完成 [**選單內容設定**](#選單內容設定-連結列表)，否則頁腳選單將沒有可選擇的內容。
...
![頁尾-選單導覽列](../../../assets/images/ec-網站外觀-套版主題管理-網站設定-頁腳-選單.png)
...
![頁尾-聯絡資訊](../../../assets/images/ec-網站外觀-套版主題管理-網站設定-頁腳-聯絡資訊.png)
...
![頁腳-選單排列樣式](../../../assets/images/ec-網站外觀-套版主題管理-網站設定-頁腳-選單排列樣式.png)
...
![頁腳-社群媒體](../../../assets/images/ec-網站外觀-套版主題管理-網站設定-頁腳-社群媒體圖示.png)
...
2. 點選 :lucide-globe: 切換至目標語言。
    ...
    ![切換語系](../../../assets/images/ec-網站外觀-選單與導覽列-編輯選單-切換語系.png)

3. 逐項點「編輯」修改選單項目名稱，輸入後按確認。

    ![輸入語系內容](../../../assets/images/ec-網站外觀-選單與導覽列-編輯選單-修改語系內容.gif)
...
=== "主選單範例"
    ...
    ![導覽列選單-多國語系-前台](../../../assets/images/ec-網站外觀-選單與導覽列-導覽列-多國語系-前台.png)
...
=== "頁腳選單範例"
    ...
    ![頁腳選單-多國語系-前台](../../../assets/images/ec-網站外觀-選單與導覽列-頁腳-多國語系-前台.png)
