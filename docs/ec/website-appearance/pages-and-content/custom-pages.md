...
本頁說明自訂頁面的新增、內容編輯、發布、複製、刪除與多語系維護等日常操作。

---

## 使用前提與限制 { #prerequisites-custom-pages }

- [x] **方案需求**:自訂頁面管理(新版)適用 **專業** 、**進階** 、**高手** 及其對應 **PLUS** 版本,以及 **企業** 方案;基本版不適用。
- [x] **無需額外設定**:符合方案的店家可直接於後台「網站外觀」>「自訂頁面管理」開始使用,不需另外開通。

??? plan "適用方案一覽"
    | 方案 | 是否適用 |
    | :-- | :-- |
    | 專業 / 進階 / 高手 | ✅ 適用 |
    | 專業 PLUS / 進階 PLUS / 高手 PLUS | ✅ 適用 |
    | 企業 | ✅ 適用 |
    | 基本版 | ❌ 不適用 |

    如不確定您的店家方案是否包含此功能,請聯繫您的 CYBERBIZ 業務窗口確認。
...
2. **於編輯頁切換:** 進入頁面編輯後,點擊上方的 **「公開」/「不公開」** 也可切換。
3. **確認前台顯示:** 點擊 **「前往該頁面」** 可於新分頁開啟前台實際頁面,確認顯示結果。
...
### 情境六、編輯多語系內容 { #operate-custom-pages-multilang }
