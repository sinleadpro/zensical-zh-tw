...
=== "新版(拖拉式)頁面"
    ...
    1. **新增區塊：** 在編輯器中點擊 **「新增區塊」**，從清單選擇要加入的區塊(例如輪播素材、圖文介紹、折疊內容、自訂 HTML 等)。可用區塊請見 [自訂頁面可用區塊對照表](../references/custom-pages-blocks.md) 。
    ...
    !!! note "註釋"
        拖拉式區塊的詳細操作與各區塊應用範例，請參考 [使用拖拉版型設計網站版面與首頁區塊](../theme-and-layout/使用拖拉版型設計網站版面與首頁區塊.md) 。
...
- :lucide-layout-dashboard:{ .lg }  
  [__使用拖拉版型設計版面__](../theme-and-layout/使用拖拉版型設計網站版面與首頁區塊.md)  
