...
created:
last_modified: 2026-06-12 16:17
lang: zh-TW
permalink:
type: tutorial
status:
...
![全站設定-商品相關設定](../../../assets/images/ec-網站外觀-拖拉版型編輯器-全站設定-商品相關設定.png)
...
![全站設定-商品相關設定-文字排列與選單](../../../assets/images/ec-網站外觀-拖拉版型編輯器-全站設定-文字排列.png)
...
- **折扣貼紙 `非PLUS版 / 企業版`：** 上傳一張貼紙圖（建議 100×100px），當任一款式售價低於定價時，自動顯示於商品圖左上角。
