...
- 僅支援 [*電子票券任選折扣*](電子票券優惠設定.md)  與 *分潤*，不可與其他優惠併用  
- 付款方式僅支援 *信用卡一次付清*
