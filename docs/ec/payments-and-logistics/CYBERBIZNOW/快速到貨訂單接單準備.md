...
cyb_extensions: ["NOW!"]
intents: ["接收訂單", "識別訂單"]
features: ["CYBERBIZ NOW", "快速到貨"]
prerequisites: ["已完成快速到貨功能串接設定", "門市已開通配送服務"]
related: []
tags: ["Pandago", "UberDirect"]
acoiv: operation
apis: []
devices: ["desktop"]
ui_components: ["訂單列表"]
paths: ["訂單 > 門市訂單"]
layouts: []
wp_url: ["https://www.cyberbiz.io/support/?p=13134", "https://www.cyberbiz.io/support/?p=13744"]
permalink: ""
comments: false
search:
  exclude: false
