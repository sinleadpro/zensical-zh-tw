...
author: Ann
reviewers: []
notes: ["內部連結：建立商品、頁腳、購物車相關設定、訂單相關設定"]
ga_views: 0
feedback: 0
products: ["EC"]
modules: ["金物流"]
...
plans: ["澳洲落地版"]
cyb_extensions: []
intents: ["申請_Airwallex_帳戶", "激活收單功能", "串接_API_密鑰"]
features: ["澳洲落地版", "跨境金流", "Airwallex_收單"]
prerequisites: ["需為澳洲落地版商家", "需先聯繫開店顧問取得申請連結"]
related: []
tags: ["Airwallex", "跨境電商"]
acoiv: integration
apis: []
devices: ["desktop"]
ui_components: []
paths: ["金物流 > 金流設定", "Airwallex 管理後台"]
layouts: []
wp_url: ["https://www.cyberbiz.io/support/?p=51285"]
permalink: ""
comments: false
search:
  exclude: false
