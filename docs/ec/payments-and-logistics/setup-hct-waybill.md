...
![新竹託運單設定頁](../../assets/images/EC-金物流-新竹物流託運單-hero.png){ title="新竹託運單設定頁" .hero-page }
...
- [x] **填寫開通申請**：至「金物流/宅配物流」>「串接物流」找到「新竹物流貨到付款」並[填寫申請表單](home-delivery-cash-on-delivery.md#2-新竹物流){ title="宅配貨到付款物流（黑貓/宅配通/新竹物流）" }。
...
![新竹物流設定](../../assets/images/EC-金物流-新竹物流託運單-新竹物流設定.png){ title="新竹物流設定" }
...
![新竹物流託運單-加印託運單](../../assets/images/EC-金物流-新竹物流託運單-加印託運單.png){ title="新竹物流託運單-加印託運單" }
...
![新竹物流逆物流](../../assets/images/EC-金物流-新竹物流託運單-新竹物流逆物流.png){ title="新竹物流逆物流" }

!!! note "逆物流計費規則"
    - **預扣** 常溫 60cm = 80 Cyber幣(僅一般版)。
...
![新竹物流單號使用紀錄](../../assets/images/EC-金物流-新竹物流託運單-單號使用紀錄.png){ title="新竹物流單號使用紀錄" }
