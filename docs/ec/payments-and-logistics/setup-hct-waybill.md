...
- [x] **填寫開通申請**：至「金物流/宅配物流」>「串接物流」找到「新竹物流貨到付款」並[填寫申請表單](宅配貨到付款（黑貓宅配通新竹物流）.md#2-新竹物流貨到付款){ title="宅配貨到付款物流（黑貓/宅配通/新竹物流）" }。
...
- :lucide-table:{ .lg }  
  [__新竹物流配送尺寸與運費對照表__](../orders/references/hct-size-fee-reference.md){ title="新竹物流配送尺寸與運費對照表" data-preview }  
