...
cyb_extensions: []
intents: ["開通順豐海外功能", "設定出口公司英文名", "建立順豐託運單"]
features: ["順豐海外物流", "自動產單"]
prerequisites: ["需具備國貿局登記之英文公司名稱"]
related: []
tags: ["跨境物流", "中港澳出貨", "燃油附加費"]
acoiv: integration
apis: []
devices: ["desktop"]
ui_components: []
paths: ["管理中心 > 一般設定", "訂單 > 所有訂單"]
layouts: []
wp_url: ["https://www.cyberbiz.io/helpcenter/?p=11280", "https://www.cyberbiz.io/support/?p=8060"]
permalink: ""
comments: false
search:
  exclude: false
