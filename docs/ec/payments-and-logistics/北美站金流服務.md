...
plans: ["Pro", "Business"]
cyb_extensions: []
intents: ["開通北美信用卡支付", "設定_PayPal_付款", "配置購物車結帳規則"]
features: ["北美站", "Stripe_支付", "PayPal", "電子錢包支付"]
prerequisites: []
related: []
tags: ["Stripe", "PayPal", "Apple Pay", "Google Pay"]
acoiv: integration
apis: []
devices: ["desktop"]
ui_components: []
paths: ["金物流 > 金流設定"]
layouts: []
wp_url: ["https://www.cyberbiz.io/support/?p=30595"]
permalink: ""
comments: false
search:
  exclude: false
