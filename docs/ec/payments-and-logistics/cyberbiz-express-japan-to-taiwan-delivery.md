...
4. **海關報關**：消費者前往 [EZWAY 完成 **申報相符** 回報](https://web.customs.gov.tw/singlehtml/3150?cntId=cus1_3150_3150_1471)。
...
=== "批次編輯"
    ...
    1. [匯出商品 Excel](../products/Excel 大量匯入商品.md#下載-excel-範本或匯出商品)。
    2. 找到報關用對應欄位進行更新。
    3. [匯入 Excel](../products/Excel 大量匯入商品.md#匯入-excel-檔案)，完成批次編輯。
