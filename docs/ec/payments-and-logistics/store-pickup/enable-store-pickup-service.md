---
title: 開啟門市取貨服務
description: 完整的門市取貨功能設定流程，包含啟用功能、設定付款方式、運費規則、取貨日期選項與門市備註管理。
...
系統預設會為所有商品開啟門市取貨功能。若特定商品（如：材積過大、需特殊溫層）不適用門市取貨，請依以下步驟手動關閉：

1. 登入 CYBERBIZ 管理後台，前往 **商品 > 所有商品**。
2. 點選欲設定的商品，進入編輯頁面。
3. 點選 **設定** 頁籤，找到 **溫層和物流配送設定** 區塊。
4. 將 **門市取貨** 開關切換為 `關閉 (OFF)`。

![](https://www.cyberbiz.io/support/wp-content/uploads/門市取貨設定15.png){ .screenshot }
...
- :lucide-clipboard-list:{ .lg }   
  [__處理門市取貨訂單__](../../orders/store-pickup-orders.md)       
  了解如何管理並核銷顧客到店取貨的訂單。

- :lucide-package-search:{ .lg }     
  [__管理門市取貨商品__](../../products/copy-products-to-quick-delivery-stores.md)  
