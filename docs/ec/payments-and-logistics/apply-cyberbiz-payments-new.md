...
- **降低盜刷風險**：可設定 [3D 驗證門檻](setup-credit-card-3d-verification.md){ title="設定信用卡 3D 驗證門檻" }。
...
- **帳務自動確認**
    ...
    - **一般版 與 PLUS版** 商家可設定金額門檻，由系統自動確認帳款，避免撥款延遲。
    - **企業版** 不支援此自動功能。
...
1. 登入 CYBERBIZ 管理後台，前往 **金物流 > 金流設定 > CYBERBIZ PAYMENTS > 開始申請**。

    ![](../../assets/images/EC-後台-金物流-金流設定-cybpayments申請流程01.png)

2. 填寫 **公司資訊**、**負責人資料** 與 **銀行帳戶資料**。

    ![](../../assets/images/EC-後台-金物流-金流設定-cybpayments申請流程02.png)

3. 完成 **KYC 身分驗證**。

    ![](../../assets/images/EC-後台-金物流-金流設定-cybpayments申請流程03.png)

4. 確認完成商店設定。

    ![](../../assets/images/EC-後台-金物流-金流設定-cybpayments申請流程04.png)

5. 送出申請後，確認合約已簽署完成，方進入[審核流程](#審核流程)。
