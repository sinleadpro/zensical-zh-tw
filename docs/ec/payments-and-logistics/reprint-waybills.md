...
reviewers: []
notes:
  - 內部連結：宅配部分出貨、超商部分出貨、已出貨狀態新增物流提示文字
ga_views: 0
feedback: 0
products:
  - EC
...
layouts: []
wp_url:
  - https://www.cyberbiz.io/helpcenter/?p=3430
  - https://www.cyberbiz.io/support/?p=15891
permalink: ""
comments: false
search:
  exclude: false
...
!!! info "系統物流部分出貨：操作指引"
    ...
    - **其他訂單**：**超商** 與 **宅配貨到不付款** 訂單，請使用 [宅配部分出貨](../orders/partial-shipment-settings.md) 或 [超商部分出貨](../orders/cvs-partial-shipment.md)。
...
| 狀態欄位 | 說明 |
| ------- | -----| 
| 已出貨 | 已下載加印託運單<br>系統會根據物流狀態提供補充資訊，可參考[已出貨狀態新增物流提示文字](../orders/shipping-status-tooltip/#shipping-status-text-type) |
