...
![超商大宗寄倉 B2C](../../assets/images/ec-金物流-超商物流-B2C.png){ title="超商大宗寄倉 B2C" .hero-page }

## 超商大宗寄倉 B2C 說明 { #intro-cvs-b2c-setup }

**超商大宗寄倉 B2C** 適用於每日出貨量較大的商家，商家將貨件集中包裝後自行寄至超商物流中心（如大智通、日翊、萊爾富物流中心），再由物流中心分發至消費者指定門市。

!!! info "超商大宗寄倉 B2C 設定流程"
...
1. 登入後台，路徑為「**金物流**」>「**超商物流**」。
2. 在通路列表中，尋找標示有「**B2C 超商大宗**」標籤的項目。
3. 可申請的通路包括：「**7-ELEVEN 超商取貨**」、「**全家超商取貨**」、「**全家冷凍超商取貨**」、「**萊爾富超商取貨**」。

![進入 B2C 設定頁](../../assets/images/ec-logistics-cvs-b2c-setup-page.png){ title="進入 B2C 設定頁" }
...
![設定運費與啟用](../../assets/images/ec-金物流-超商物流-B2C 設定.gif){ title="設定運費與啟用" }
...
- :lucide-truck:{ .lg }  
  [__使用超商大宗寄倉 B2C 出貨__](../orders/cvs-shipping/cvs-b2c-bulk-shipping.md){ title="使用超商大宗寄倉（B2C）出貨" }  
...
- :lucide-package:{ .lg }  
  [__設定商品重量與材積__](../products/shipping/cvs-shipping-restrictions-exclusions.md){ title="設定超商配送限制與物流排除" }  
