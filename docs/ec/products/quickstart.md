...
- [__新增單一商品__](docs/ec/products/creation/新增單一商品.md){ data-preview }   
建立單一商品並上架
...
使用 Excel 範本一次更新大量商品。
- [__批次設定多款式商品資訊__](docs/ec/products/creation/新增單一商品.md#批次操作多款式商品)  
同步更新多款式商品資訊。
...
檢視已[開啟管理庫存功能](docs/ec/products/creation/新增單一商品.md#庫存管理)以及庫存設定有限數量的商品。

![](../../assets/images/ec-inventory-list.zh-tw.png)

<div class="grid cards" markdown>

- [__庫存水位通知__](docs/ec/products/creation/新增單一商品.md#庫存管理)  
設定庫存低於一定數量會主動通知商家。
