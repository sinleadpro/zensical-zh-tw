...
- [__新增單一商品__](新增單一商品.md){ data-preview }   
建立單一商品並上架
...
3. 啟用 / 關閉 **商品搜尋** 選項。
> *開啟 (ON)*（商品可被搜尋）；*關閉 (OFF)*（商品無法被搜尋）。[了解更多](設定商品排除搜尋#適用範圍)。
...
使用 Excel 範本一次更新大量商品。
- [__批次設定多款式商品資訊__](新增單一商品#批次操作多款式商品)  
同步更新多款式商品資訊。
...
檢視已[開啟管理庫存功能](新增單一商品#庫存管理)以及庫存設定有限數量的商品。

![](../../assets/images/ec-inventory-list.zh-tw.png)

<div class="grid cards" markdown>

- [__庫存水位通知__](新增單一商品#庫存管理)  
設定庫存低於一定數量會主動通知商家。
