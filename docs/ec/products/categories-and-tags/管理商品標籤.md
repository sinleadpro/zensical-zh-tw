...
- :lucide-tags: [__Google Merchant Center__](../../integrations/google/設定 Google Merchant Center 並同步 CYBERBIZ 商品.md){ title="設定 Google Merchant Center 並同步 CYBERBIZ 商品" }    
- :simple-facebook: [__FB 動態產品目錄__](../../integrations/fb/meta-ads/同步商品影片至 Meta 目錄.md){ title="同步商品影片至 Meta 目錄" }
- :simple-line: [__LINE 購物__](../../integrations/line/申請與設定 LINE 購物導購.md){ title="申請與設定 LINE 購物導購" }
- :simple-stryker: [__美安 SHOP.COM__](../../integrations/串接美安通路.md){ title="串接美安通路" } 僅支援 `贈品` 標籤
</div>
...
- [批次修改商品描述與配送設定](../bulk-operations/批次修改商品描述與配送設定.md){ title="批次修改商品描述與配送設定" }
