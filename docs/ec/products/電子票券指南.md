...
[:lucide-lock:{ title="適用方案" }](../../resources/conventions#適用方案) | PLUS 企業  [:lucide-toggle-right:{ title="適用功能" }](../../resources/conventions#適用功能) |  新版物流
...
[:material-numeric-1-circle-outline: 新增 ](#新增電子票券) [:material-numeric-2-circle-outline: 購買 ](#購買電子票券) | [:material-numeric-3-circle-outline: 核銷](#核銷電子票券) | [:material-numeric-4-circle-outline: 退款](#電子票券退款) | [:material-numeric-5-circle-outline: 分票](#電子票券分票) | 
{ .lg } 
