...
![](docs/assets/images/ec-product-tag-management.zh-tw.png){  title="管理商品標籤：商品 > 商品標籤管理"  .hero-page }
...
![](docs/assets/images/ec-add-product-tag.zh-tw.png)
...
![](docs/assets/images/ec-product-settings-tag.zh-tw.png)
...
![](docs/assets/images/ec-remove-product-from-tag-collection.zh-tw.png)
...
![](docs/assets/images/ec-product-tag-collection-delete.zh-tw.png)
...
![](docs/assets/images/ec-remove-upload-to-third-party-platform-tag.zh-tw.png)
