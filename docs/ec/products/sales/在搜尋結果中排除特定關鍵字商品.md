...
3. **修改程式碼**：
	...
	``` liquid hl_lines="6"
	{% include 'breadcrumb', url: "home" %}
	
	<div id="search">
	  <div class="container">
	
	    {% assign product_results = search.products | without: 'title', 'VIP專屬' %}
	      ...
	      <div class="row">
	        <div class="col-12 ml-auto mr-auto">
	          <div class="alert alert-info" role="alert">
	            搜尋「<span>{{ q }}</span>」，總共有 <strong>{{ results_sizes }}</strong> 項搜尋結果
	          </div>
	        </div>
	        </div>
	    {% endif %}
