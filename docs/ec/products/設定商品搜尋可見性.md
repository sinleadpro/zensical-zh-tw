...
![](docs/assets/images/ec-product-list-search-index-toggle.png)
...
![](docs/assets/images/ec-add-product-product-search-index.png)
...
4. 選擇 **開啟搜尋** 或 **排除搜尋**，以設定商品搜尋狀態。
  ...
  ![](docs/assets/images/ec-product-list-selector-enable-search-exclude.png)
...
5. 系統將依設定批次套用。
  ...
  ![](docs/assets/images/ec-import-from-excel-if-exclude-search.png)
