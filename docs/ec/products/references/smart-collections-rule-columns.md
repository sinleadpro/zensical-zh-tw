---
title: 條件分類篩選欄位對照表
description: "彙整「商品條件分類」可用的篩選欄位及其可搭配的比對條件，供條件分類設定參考。"
created: 2026-06-03 21:50
last_modified: 2026-07-02 10:06
lang: zh-TW
type: reference
author: Jase
reviewers: []
...
!!! note "註釋"
    ...
    * 各條件的詳細意義請見[篩選條件對照表](smart-collections-rule-relations.md){ title="條件分類篩選條件對照表" }。
