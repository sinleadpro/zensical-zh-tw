...
last_modified: 2025-12-28 00:00
lang: zh-TW
type: tutorial
status:
version:
...
2. 依照需求變更設定。
	...
	- **Google reCAPTCHA**：安全驗證機制，防止垃圾訊息與機器人留言。瞭解 [如何設定留言區 reCAPTCHA](../../website-appearance/customer-interaction/啟用留言區 reCAPTCHA)。
	- **審核後贈送紅利點數**：設定商家審核通過顧客評論後，是否自動贈送紅利點數。
3. 點擊 **更新**，套用變更。

![](docs/assets/images/ec-product-review-management.zh-tw.png)

#### 檢視留言板
所有商品的留言板皆可在此細部設定，按下 **檢視** 可對個別留言板進行編輯。

![](docs/assets/images/ec-comment-board-list.zh-tw.png)

#### 設定留言板
在留言板列表點擊「檢視」特定留言板，可進入留言版編輯頁，對各別留言板進行設定。點擊 **垃圾桶 :material-trash-can-outline:** 可刪除商品評論。

![](docs/assets/images/ec-comment-board.zh-tw.png)
...
![](docs/assets/images/ec-product-review-frontend.zh-tw.png)
...
![](docs/assets/images/ec-product-review-approval-pending.zh-tw.png)
...
- [__啟用留言區 reCAPTCHA__](../../website-appearance/customer-interaction/啟用留言區 reCAPTCHA)  
  防止機器人訊息及垃圾留言。
- [__FB 分享商品評論__]()  
