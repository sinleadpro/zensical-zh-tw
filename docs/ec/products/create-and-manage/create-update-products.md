...
last_modified: 2026-07-06T17:22:39+08:00
lang: zh-TW
type: tutorial
status: ""
version: ""
...
- [x] **商品成本價、款式材積：** 開通後才會在款式中出現「成本價」「材積(CM)」欄位。
- [x] **商品影片：** 方案限定開通功能，且僅支援 **拖拉版型** 的主題，前台才能正常顯示。
- [x] **自訂欄位：** 方案限定開通功能，開通後會在編輯商品時出現「自訂欄位」區塊。
- [x] **運送溫層與物流綁定：** 方案限定開通功能，開通後會在 **設定** 分頁出現溫層與物流配送設定。
