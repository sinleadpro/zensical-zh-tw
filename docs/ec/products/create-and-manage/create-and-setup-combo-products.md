...
=== "一般、PLUS"
    ...
    組合商品是將兩個或以上的商品組合成單一商品進行販售的商品類型。商家可設定固定內容的 **指定組合商品**，或讓消費者自行選擇內容的 **任選組合商品**。
    
    - **指定組合商品**：區塊內商品與數量由商家固定，顧客不可更改。
    - **任選組合商品**：設定該區塊的 **任選數量總額**，顧客可從清單中自由挑選。
...
- **後台商品標籤**
    ...
    2. 使用情境
        ...
        為組合商品設定 **商品標籤** 後，該組合商品可視為標籤範圍內的商品，可參與 **以商品標籤指定適用對象** 的行銷活動。

        **可搭配的活動類型**：

        - [優惠碼](../../marketing/coupon/setup-promo-codes.md)／[優惠券](../../marketing/coupon/setup-coupons.md)：以商品標籤限定折價適用商品
        - [商品滿額／件贈](../../marketing/discounts/threshold-gifts-and-quantity-gifts.md)：以商品標籤限定計入贈送門檻的商品
        - [商品加價購](../../marketing/upsells/setup-product-upsell.md)：以商品標籤限定主商品條件範圍

    3. 設定位置

        前往 **設定** 頁籤，指定 **標籤**。

        ![](../../../assets/images/EC-後台-商品-組合商品-綁定商品標籤01.png)
...
=== "一般、PLUS"
    ...
    ![](../../../assets/images/EC-後台-商品-組合商品-建立v2組合品01.png){ .screenshot }
...
=== "企業"
    ...
    - **商品簡述**：建議 1–3 句，避免冗長段落。顯示於商品頁的簡短描述。
    - **上架狀態**：設定商品上架與下架時間，未填寫表示商品永久上架；非上架時間將顯示 404。
    - **定價／售價**：**定價** 為商品原價，**售價** 為顧客實際結帳的銷售價格。
    - **紅利折抵**：設定該組合商品允許會員使用紅利點數折抵的上限。
    - **廠商編號**：輸入用於內部管理或與供應商溝通的廠商識別代碼。
    - **商品編號（SKU）**：設定組合商品的唯一庫存單位編號，建議與子商品的編號區隔，以利訂單管理。

    ![](../../../assets/images/EC-後台-商品-組合商品-建立組合品01.png){ .screenshot }
    ...
    1. **選擇組合商品類型**：
        ...
        === "指定組合"
            ...
            **組合類型** 選擇 **指定組合商品** 即可。
            ...
            ![](../../../assets/images/EC-後台-商品-組合商品-建立v2組合品02.png){ .screenshot }

        === "任選組合"

            **組合類型** 選擇 **任選組合商品**，並指定該組合的選購總數。

            ![](../../../assets/images/EC-後台-商品-組合商品-建立v2組合品03.png){ .screenshot }

        !!! warning "組合商品建立後，組合類型不可修改"
    
    2. **加入商品**：在區塊內 **選擇商品**，於彈窗中勾選商品。
...
=== "一般、PLUS"
    ...
    === "指定組合"
        ...
        ![](../../../assets/images/EC-前台-商品頁-指定組合品01.png){ .screenshot }
