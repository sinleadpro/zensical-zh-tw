...
- :lucide-import:{ .lg }   
  [__批次修改商品描述與設定__](../bulk-operations/batch-update-product-descriptions-shipping.md){ title="批次修改商品描述與配送設定" }     
  匯入編輯過的商品 Excel 檔案，同步更新多筆商品的商品描述與配送相關設定。

- :lucide-ban:{ .lg }     
  [__物流限制與排除選項__](../shipping/cvs-shipping-restrictions-exclusions.md){ title="設定超商配送限制與物流排除" }  
