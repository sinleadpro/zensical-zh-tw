...
![商品頁設定-色票-預設版型](../../../assets/images/ec-網站外觀-商品頁設定-商品色票-預設版型.png){ title="商品頁設定-色票-預設版型" .hero-page }
...
!!! info "拖拉版型使用者"
    若您使用的是「拖拉版型」，請參閱[設定商品色票與款式圖片-拖拉版型](product-swatches-variant-images-drag-drop.md){ title="設定商品色票與款式圖片-拖拉版型" }。
...
![商品色票-商品列表頁顯示-預設版型](../../../assets/images/ec-網站外觀-商品色票-前台商品列表頁-預設版型.png){ title="商品色票-商品列表頁顯示-預設版型" }

## 色票與規格設定流程

### 步驟一：設定色票圖示

系統透過圖片的「相對位置」自動配對款式實照與色票圖示。請將圖片上傳至「商品圖片」區塊（上傳規範請參考 [新增商品：商品圖片與影片](create-update-products.md#operate-product-create-media){ title="新增與更新商品" }），並遵循 「先圖後色」 的分段排序邏輯。
...
![商品圖片-色票排序](../../../assets/images/ec-商品-商品圖片-色票排序-預設版型.png){ title="商品圖片-色票排序" }

---

### 步驟二：款式規格管理（關鍵步驟）

完成 [圖片上傳](#步驟一設定色票圖示) 後，請向下捲動至 「款式與庫存」 區塊。為了讓系統正確對應色票，規格的設定順序與命名具有硬性限制。
...
![商品色票款式設定](../../../assets/images/ec-商品-商品色票款式設定-預設版型.png){ title="商品色票款式設定" }
...
![商品款式管理-庫存設定](../../../assets/images/ec-商品-款式設定-庫存管理.gif){ title="商品款式管理-庫存設定" }

---

### 步驟四：前台畫面顯示

![商品色票-前台-預設版型](../../../assets/images/ec-商品色票-前台-預設版型.png){ title="商品色票-前台-預設版型" }
...
??? quote "商品色票會顯示在哪個位置？"
    ...
    ![商品色票-商品群組頁-前台](../../../assets/images/ec-商品色票-前台-商品群組頁-預設版型.png){ title="商品色票-商品群組頁-前台" }
...
??? quote "此功能是否適用於所有版型？"
    ...
    本教學僅適用於 **預設版型**。若您使用的是「拖拉版型」，請參閱[設定商品色票與款式圖片-拖拉版型](product-swatches-variant-images-drag-drop.md){ title="設定商品色票與款式圖片-拖拉版型" }。
