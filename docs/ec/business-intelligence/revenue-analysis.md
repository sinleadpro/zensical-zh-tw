...
created: 2026-06-15
last_modified: 2026-07-10 10:26
lang: zh-TW
type: tutorial
status: ""
author: Jase
...
3. **切換顯示項目：** 點擊圖表上方的項目名稱，可在圖表中隱藏或顯示該項目的資料線，便於聚焦特定項目進行分析。
4. **比對趨勢：** 透過同一張圖中多條線的相對高低，觀察營收、成本與毛利之間隨時間的變化關係。
...
將滑鼠移到圖塊上，即會顯示該項目的營收金額與占比百分比。點擊項目名稱，可隱藏或顯示該項目資料。
...
將滑鼠移到圖塊上，即會顯示該付款方式的營收金額與占比百分比。點擊項目名稱，可隱藏或顯示該項目資料。
...
將滑鼠移到圖塊上，即會顯示該出貨方式的營收金額與占比百分比；點擊項目名稱，可隱藏或顯示該項目資料。
...
將滑鼠移到長條上，即會顯示各會員類型的營收金額；點擊項目名稱，可隱藏或顯示該項目資料。
...
將滑鼠移到資料點上，即會顯示該時段的營收金額；點擊項目名稱，可隱藏或顯示該項目資料。
...
將滑鼠移到長條上，即會顯示該日的營收金額；點擊項目名稱，可隱藏或顯示該項目資料。
...
??? quote "圖表數字和訂單列表的金額對不起來"
    ...
    - 已取消、已退貨的訂單金額不會計入營收。
    - 詳細定義請見[認列訂單定義](#prerequisites-revenue-counted-orders){ title="認列訂單定義" data-preview }。
