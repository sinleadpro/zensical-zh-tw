...
created: 2026-06-16
last_modified: 2026-06-17 13:03
lang: zh-TW
type: tutorial
status: ""
version: ""
...
**看回購週期：** 「會員平均回購週期天數」估算會員兩次下單之間的平均間隔，可作為回購推播時機的參考(例如在接近平均週期前提醒會員回購)。
...
**看人均消費：** 「會員人均消費額 月趨勢」呈現每月平均每位購買會員貢獻的金額，觀察客單貢獻是上升或下滑。將滑鼠移動到圖表上方可查看各月資料。
...
**看平均訂單數：** 「會員平均認列訂單數 月趨勢」為總認列訂單數除以總會員數，反映平均每位會員帶來的訂單量。
...
**看回購率：** 「會員回購率」為下過 2 次以上訂單的客戶數，除以曾下過訂單的客戶數，是衡量黏著度的核心指標。
