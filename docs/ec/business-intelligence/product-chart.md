...
last_modified: 2026-06-21 23:36
lang: zh-TW
type: tutorial
status: ""
version: ""
...
- [x] **方案需包含「商品圖表」功能**：本頁屬於基礎的營運報表。若您在後台「營運圖表分析」中找不到「商品圖表」，代表目前方案未包含此功能，可洽詢客服。
...
??? quote "後台找不到「商品圖表」選單怎麼辦？"
    [](){ #faq-product-chart-no-menu }
    這代表您目前的方案未包含「商品圖表」功能。

    部分進階方案(如企業版)會改提供功能更完整的「商品分析」，請改至該頁面查看；若仍有疑問，可洽詢客服協助確認方案內容。
