...
![網站權限頁面](../../assets/images/ec-管理中心-網站權限.png){ title="網站權限頁面" .hero-page }
...
![新增管理員](../../assets/images/ec-管理中心-網站權限-新增管理員.gif){ title="新增管理員" }
...
![修改管理者權限](../../assets/images/ec-管理中心-修改管理者權限.gif){ title="修改管理者權限" }
...
!!! note "詳細設定請參閱 [管理者權限與後台選單對應表](references/admin-permissions-menu-reference.md){ title="管理者權限與後台選單對照表" data-preview }。"
