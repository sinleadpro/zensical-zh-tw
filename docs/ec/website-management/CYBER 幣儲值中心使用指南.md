...
last_modified: 2026-04-28 12:25
lang: zh-TW
type: guide
status: ""
author: Jase
...
- :lucide-wallet:
  **[CYBER 幣購買中心](#查詢-cyber-幣餘額){ data-preview }**
  顯示目前餘額，提供儲值入口

- :lucide-message-square:
  **[簡訊追蹤服務](#簡訊sms){ data-preview }**
  說明簡訊計費方式

- :lucide-mail:
  **[EDM 發送服務](#電子報edm){ data-preview }**
  說明電子報計費方式

- :lucide-credit-card:
  **[立即購買 CYBER 幣](#如何儲值-cyber-幣){ data-preview }**
  輸入儲值金額、選擇付款方式

- :lucide-receipt:
  **[儲值紀錄](#查詢儲值紀錄){ data-preview }**
  查詢歷次儲值交易明細

- :lucide-file-text:
  **[明細紀錄](#查詢-cyber-幣使用明細){ data-preview }**
  查詢 CYBER 幣消費使用明細

- :lucide-download:
  **[明細匯出](#匯出-cyber-幣使用明細){ data-preview }**
  依日期範圍匯出 Excel 報表
