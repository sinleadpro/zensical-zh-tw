...
![網站轉址設定](../../../assets/images/ec-管理中心-網站轉址.png){ title="網站轉址設定" .hero-page }
...
- [x] **轉換建議**：建議以「有價值」的熱門頁面進行轉換為主，不一定要針對所有頁面執行。
- [x] **中文網址**：若網頁為中文網址，請特別注意轉址設定時 **請勿使用亂碼** 進行操作。
...
![新增轉址網址](../../../assets/images/ec-管理中心-網站轉址-新增轉址網址.png){ title="新增轉址網址" }
...
![Excel 轉址範本](../../../assets/images/ec-管理中心-網址轉址-excel範本.png){ title="Excel 轉址範本" }
