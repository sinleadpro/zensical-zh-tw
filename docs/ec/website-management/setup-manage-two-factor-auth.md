...
![二階段驗證設定](../../assets/images/ec-管理中心-安全性設定-二階段驗證.png){ title="二階段驗證設定" .hero-page }
...
*   **推薦應用程式**：CYBERBIZ 建議[使用 Authy](authy-two-factor-authentication.md){ title="使用 Authy 啟用二階段驗證設定" }，因其具備良好的備份與復原機制。
...
*   **查看進度**：可點擊「管理人員安全驗證」按鈕，查看所有管理員是否已開啟驗證及其啟用時間。
    ...
    ![管理人員安全驗證](../../assets/images/ec-管理中心-安全性設定-二階段驗證-管理人員安全驗證.gif){ title="管理人員安全驗證" }
...
*   **強制開啟**：擁有者可開啟「**強制所有員工開啟二階段驗證**」。開啟後，所有相關人員必須完成設定才能繼續使用系統。
    ...
    ![強制開啟二階段驗證](../../assets/images/ec-管理中心-安全性設定-二階段驗證-強制開啟.png){ title="強制開啟二階段驗證" }
...
![備用碼登入](../../assets/images/ec-管理中心-安全性設定-二階段驗證-備用碼登入.png){ title="備用碼登入" }
