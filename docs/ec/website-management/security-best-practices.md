...
| [會員個資部分隱碼](admin-security-settings.md#operate-security-pdpa) | 於訂單明細中遮蔽顧客姓名、手機、地址等個資 | 管理中心/安全性設定 > 會員安全 |
...
-   :lucide-download:{ .lg .middle } __匯出權限最小化__
    ...
    [:lucide-arrow-right: 設定步驟](add-admin-set-permissions.md#管理者權限設定與修改)
