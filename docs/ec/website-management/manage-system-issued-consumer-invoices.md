...
last_modified: 2026-09-18 10:50
lang: zh-TW
type: guide
author: Ann
reviewers: []
...
| 訂單類型 | 判斷欄位 | 觸發狀態 | 發票執行動作 | 系統處理說明 |
| :--- | :--- | :--- | :--- | :--- |
| 貨到付款 | 配送狀態 | **部分出貨**<br>**已出貨** | **開立發票** | 只要執行訂單 **出貨**，系統即自動開立整張訂單的電子發票<br>若 **部分出貨** 後，剩餘未出貨商品執行退貨，則系統自動進行部分折讓 |
| 非貨到付款 | 付款狀態 | **已收到款項** | **開立發票** | 系統自動開立電子發票 |
| 非貨到付款 | 付款狀態 | **付款失敗** | **不予開立** | 交易未完成，系統不產生發票 |
| 不限 | 付款狀態 | **部分退款**<br>**已退款** | **開立折讓** | 退款完成後，系統自動產生折讓單<br>部分退款則開立部分折讓單 |
...
顧客收到通知後，可持中獎資訊前往 **全家便利商店 (FamilyMart)** 使用 **FamiPort** 機台，列印紙本發票進行兌獎。

> 超商列印中獎發票的手續費會由 CYBERBIZ 負擔。
