...
- **匯入限制**：透過 **Excel 大量匯入** 的顧客資料，**不支援** 此自動貼標功能。
     ...
     > 使用 [Excel 大量匯入會員](../members/batch-import-and-edit-members.md#excel-核心欄位說明){ title="批次匯入 / 編輯會員" }，您只需在範本中填寫標籤欄位，匯入時即可自動完成標籤套用。
...
- :lucide-tags:{ .lg }   
  [__管理個別會員標籤__](../members/manage-member-profiles.md#任務五行銷標籤與分眾管理){ title="管理會員檔案" }       
  了解如何手動為個別會員新增或移除標籤。
