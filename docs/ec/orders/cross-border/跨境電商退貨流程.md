...
permalink: https://help.cyberbiz.io/ec/orders/cross-border/cross-border-return
comments: false
search:
  exclude: false
icon: lucide/lock
...
=== "全部退貨"
    ...
    3. 狀態更動後，請接續進行 [退款操作](跨境電商退款流程.md){ title="跨境電商退款流程" }。
...
=== "部分退貨"
    ...
    6. 狀態更動後，請接續進行 [退款操作](跨境電商退款流程.md){ title="跨境電商退款流程" }。
