...
intents: ["執行人工退款操作", "手動更新訂單狀態"]
features: ["人工退款", "金流狀態管理"]
prerequisites: ["需先與顧客確認線下退款方式 (如匯款)", "確認該訂單為第三方支付 (LINE Pay / 街口 / PayPal)"]
related: []
tags: ["人工退款", "第三方支付"]
acoiv: operation
apis: []
...
permalink: https://help.cyberbiz.io/ec/orders/第三方支付訂單人工退款
comments: false
search:
  exclude: false
icon: 
