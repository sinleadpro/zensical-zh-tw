...
layouts: []
wp_url:
  - https://www.cyberbiz.io/helpcenter/?p=10999
  - https://www.cyberbiz.io/helpcenter/?p=34
  - https://www.cyberbiz.io/helpcenter/?p=10
  - https://www.cyberbiz.io/support/?p=45545
  - https://www.cyberbiz.io/support/?p=624
...
![訂單管理介面](../../../assets/images/ec-訂單-所有訂單.png){ title="訂單管理介面" .hero-page }

## 訂單介面說明 { #orders }

**所有訂單** 頁面是商家管理銷售紀錄、處理出貨作業及追蹤貨態的核心介面。
...
![編輯欄位與排序](../../../assets/images/ec-訂單-所有訂單-編輯欄位.gif){ title="編輯欄位與排序" }
...
![檢視群組功能](../../../assets/images/ec-所有訂單-檢視群組.gif){ title="檢視群組功能" }
...
![訂單搜尋功能](../../../assets/images/ec-訂單列表-搜尋.png){ title="訂單搜尋功能" }
...
![訂單明細預覽](../../../assets/images/ec-所有訂單-明細預覽.png){ title="訂單明細預覽" }
...
![商品詳情預覽](../../../assets/images/ec-訂單列表-商品詳情預覽.gif){ title="商品詳情預覽" }
...
![調整顯示筆數](../../../assets/images/ec-所有訂單-顯示筆數.png){ title="調整顯示筆數" }

---

## 訂單詳情頁面

**「訂單詳情頁」** 是處理單筆訂單、查看交易紀錄與聯繫顧客的核心介面。您可以透過後台 **訂單 > 所有訂單** 點擊特定的 **訂單編號** 進入該頁面。
...
![訂單詳情頁操作按鈕](../../../assets/images/EC-訂單詳情頁-核心按鈕.png){ title="訂單詳情頁操作按鈕" }
...
- **貨款資訊：** 顯示付款方式與狀態（如：等待付款、已收到款項）。
	...
	- 若會員使用 **銀行轉帳** 付款，當商家確認已收到款項，請按下「確認收款」，將付款狀態變更成已收到款項。
...
=== "未出貨"
	...
	![未出貨區塊](../../../assets/images/ec-訂單明細頁-貸款與出貨區塊-未出貨.png){ title="未出貨區塊" }

=== "已出貨"

	![已出貨區塊](../../../assets/images/ec-訂單明細頁-貸款與出貨區塊-已出貨.png){ title="已出貨區塊" }
...
![備註與物流訊息](../../../assets/images/ec-訂單明細頁-備註與物流訊息.png){ title="備註與物流訊息" }
...
- **管理員備註：** 僅限後台管理員查看的備註紀錄，**消費者看不到此處內容**。
- **顧客其他未結案訂單**：該顧客其他尚未結案的訂單，可幫助商家判斷是否出貨。

![訂單對話與未結案訂單](../../../assets/images/ec-訂單明細頁-訂單對話與未結案訂單.png){ title="訂單對話與未結案訂單" }

---

### 訂單操作紀錄 <small>重要歷史紀錄</small> { #order-history }
...
![訂單操作紀錄](../../../assets/images/ec-訂單明細頁-訂單操作紀錄.png){ title="訂單操作紀錄" }
...
### 退貨審查區塊 <small>特定狀態下出現</small>

當訂單進入「退貨審查」狀態後，明細頁會出現 **「部分退款」** 欄位。商家可在此勾選要退貨的商品、輸入退款金額，並點擊「確認退款」來完成流程。

![部分退款區塊](../../../assets/images/ec-訂單明細頁-部分退款.png){ title="部分退款區塊" }
...
![批次操作功能](../../../assets/images/ec-訂單列表-更多操作.png){ title="批次操作功能" }
