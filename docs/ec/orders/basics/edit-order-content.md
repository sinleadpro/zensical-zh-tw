...
last_modified: 2026-06-29 21:48
lang: zh-TW
type: tutorial
status: ""
author: Jase
...
1. 點選「新增商品」，從彈窗中搜尋（[搜尋機制](../../products/create-and-manage/product-management-interface.md#篩選器使用邏輯){ title="商品管理介面總覽" }）後勾選點擊 **確認新增** 加入品項（僅限溫層與通路相同的商品）。
