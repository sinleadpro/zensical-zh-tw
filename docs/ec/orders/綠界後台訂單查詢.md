...
plans: ["專業", "進階", "高手"]
cyb_extensions: []
intents: ["查詢信用卡交易明細", "查詢全方位金流訂單", "查詢物流對帳明細"]
features: ["綠界金流", "綠界物流", "訂單查詢"]
prerequisites: ["[[已開通綠界金流或物流服務]]"]
related: []
tags: ["綠界科技", "ECPay", "對帳", "金流查詢"]
acoiv: operation
apis: []
devices: ["desktop"]
ui_components: []
paths: ["外部系統 > 綠界管理後台"]
layouts: []
wp_url: ["https://www.cyberbiz.io/helpcenter/?p=3966", "https://www.cyberbiz.io/support/?p=21450"]
permalink: https://help.cyberbiz.io/ec/orders/綠界後台訂單查詢
comments: false
search:
  exclude: false
icon: 
