...
last_modified: 2026-08-20 17:00
lang: zh-TW
type: guide
author: Jase
reviewers: []
...
![訂單列表-退貨中](../../../assets/images/EC-訂單-所有訂單-更多操作-退貨中-hero.png){ title="訂單列表-退貨中" .hero-page }
...
!!! note "退款方式的限制"
    超過一定天數後，部分金流無法自動退刷，須改走人工退款。各金流的可自動退刷期限請見 [自動退刷時效對照表](../references/auto-refund-timeline.md){ data-preview }。
...
??? info "峰潮串倉商家"
      ...
      例外情況仍依一般流程操作：**POS 訂單**，以及部分串倉商家中 **未由峰潮履行** 的訂單。
...
![退貨時間調整設定](../../../assets/images/EC-金物流-結帳頁物流設定-前台退貨設定-退貨時間調整.png){ title="退貨時間調整設定" }
...
=== "新版訂單列表"
    ...
    ![訂單列表-退貨中](../../../assets/images/EC-訂單-所有訂單-更多操作-退貨中.png){ title="訂單列表-退貨中" }
...
=== "舊版訂單列表"
    ...
    ![訂單列表-退貨中-舊版](../../../assets/images/EC-訂單-所有訂單-更多操作-退貨中-舊版訂單列表.png){ title="訂單列表-退貨中-舊版" }
...
![訂單列表-退貨審查](../../../assets/images/EC-訂單-所有訂單-更多操作-退貨審查.png){ title="訂單列表-退貨審查" }
...
=== "全額退款"
    ...
    2. **判斷退款方式**：系統會依該筆訂單的付款金流與付款日期，自動判斷可否走自動退刷。詳見 [自動退刷時效對照表](../references/auto-refund-timeline.md){ data-preview }。
...
=== "部分退款"
    ...
    !!! tip "系統金流可依指定金額退款"
        使用系統提供的金流服務 **CYBERBIZ PAYMENTS** ，部分退款時可依輸入金額退給顧客。
