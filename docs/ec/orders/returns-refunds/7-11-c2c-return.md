...
- [x] **配送狀態**：CYBERBIZ 物流訂單需為「已出貨 / 到貨 / 收貨」；其他物流訂單需為「已出貨」
...
4. **選擇通知方式**：畫面會彈出 **「發送 7-11 C2C 退貨代碼」** 視窗，提示「發送代碼後，貨態將改為「退貨中」。」，並提供兩種通知方式可勾選(至少需勾選一項才能送出):
    * **透過簡訊通知消費者**：一封簡訊會扣 CYBER 幣，系統會把代碼發送至消費者下單時填寫的手機號碼。
...
- :lucide-check-circle:{ .lg }  
  [__退貨審查與退款執行__](../order-return-process.md){ title="訂單退貨流程" }  
  包裹簽收後系統自動改為「退貨審查」，商家需逐項確認商品狀況，再依原付款方式啟動退刷或人工退款流程。

- :lucide-credit-card:{ .lg }  
  [__其他金流退款__](../order-refund-process.md){ title="訂單退款流程" }  
...
??? quote "為什麼訂單列表的批次動作裡找不到「發送 7-11 C2C 退貨寄件代碼」？"
    ...
    - 商店是否已向 CYBERBIZ 客服申請開通「7-ELEVEN C2C 退貨便」功能
...
- [訂單發送條件對照表](../references/c2c-return-conditions.md){ title="7-11 C2C 退貨便 — 訂單發送條件對照表" data-preview }
