...
![出貨明細設定](../../../assets/images/EC-金物流-結帳頁物流設定-列印出貨明細-hero.png){ title="出貨明細設定" .hero-page }
...
![出貨明細內容設定](../../../assets/images/EC-金物流-結帳頁物流設定-列印出貨明細-設定.png){ title="出貨明細內容設定" } 
...
![出貨明細設定-儲存](../../../assets/images/EC-金物流-結帳頁物流設定-列印出貨明細-儲存按鈕.png){ title="出貨明細設定-儲存" }
...
![出貨明細預覽](../../../assets/images/EC-金物流-結帳頁物流設定-列印出貨明細-進階設定-出貨明細預覽.png){ title="出貨明細預覽" }
...
![出貨明細設定-回復預設樣板](../../../assets/images/EC-金物流-結帳頁物流設定-列印出貨明細-進階設定-回復預設樣板.png){ title="出貨明細設定-回復預設樣板" }
...
- :lucide-receipt:{ .lg }  
  [__設定與列印訂單明細__](order-detail-print.md){ title="設定與列印訂單明細" }  
