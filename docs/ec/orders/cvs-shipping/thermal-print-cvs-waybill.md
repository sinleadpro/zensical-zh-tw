...
![超商熱感列印](../../../assets/images/ec-訂單-下載超商 B2C托運單.png){ title="超商熱感列印" .hero-page }
...
![託運單A4範例](../../../assets/images/ec-訂單-超商托運單範例-A4.png){ title="託運單A4範例" }
/// caption
一般列印-A4
///
![託運單A6範例](../../../assets/images/ec-訂單-超商托運單範例-A6.png){ title="託運單A6範例" }
/// caption
熱感列印-A6
///
...
![列印超商託運單](../../../assets/images/ec-訂單-列印超商 B2C 托運單.gif){ title="列印超商託運單" }

!!! info "若訂單非超商物流，系統不會顯示熱感列印選項。"

---

### 多筆列印 <small>連續列印</small>
...
!!! warning "若同時勾選不同物流商（例如 7-11 + 全家），系統將不顯示下載選項。"
