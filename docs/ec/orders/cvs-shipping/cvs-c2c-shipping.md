...
created:
last_modified: 2026-06-10 21:21
lang: zh-TW
...
??? quote "消費者逾期未取，包裹會怎麼處理？"
    ...
    5. 「宅配到付」的地址為 EC 後台 > 一般設定 > [公司物流地址](../../website-management/設定網站基本資訊.md#公司物流地址與訂單格式){ data-preview }，請務必設定並填寫完整。
...
<!-- ## 超商店到店（C2C）出貨說明 -->
<!---->
<!-- 商家採取便利商店寄至便利商店 (又稱 C2C) 的出貨流程，支持的超商物流服務包括： -->
<!---->
<!-- - **7-ELEVEN（交貨便）** -->
<!-- - **全家（店到店）** -->
<!-- - **萊爾富（超商取貨）**     -->
...
<!-- !!! info "請先儲值 Cyber幣" -->
<!---->
<!-- 	- 一般版 商家請先 [儲值 Cyber幣](#) (管理中心 > 儲值中心)，若儲值金額不足將無法列印託運單。 -->
<!-- 	- PLUS版 / 企業版 商家無需手動儲值，系統將依每期對帳單收取 CYBERB 幣。 -->
<!-- 	- 萊爾富列印託運單後將預扣 Cyber幣，若未寄件將於 14 天後回補。 -->
<!---->
<!-- 1. 登入 CYBERBIZ 管理後台，前往 **訂單 > 所有訂單**。 -->
<!-- 2. 勾選相同配送方式（如萊爾富貨到付款）的訂單。 -->
...
<!--     - 揀貨單 -->
<!---->
<!--     !!! warning "壓縮檔若無法下載請檢查，瀏覽器是否阻擋彈跳視窗。" -->
<!---->
<!-- --- -->
<!---->
<!-- ### 步驟三：列印與貼單 -->
...
<!-- 	3. 領回時需出示寄件人身分證件，**公司寄件人姓名務必正確**。 -->
<!-- 	4. 若 7 日內未領回，包裹將送至 大智通/日翊/萊爾富 物流中心，再以「宅配到付」寄回商家。 -->
<!-- 	5. 「宅配到付」的地址 為 EC 後台 > 一般設定 > [公司物流地址](../../website-management/設定網站基本資訊.md#公司物流地址與訂單格式){ data-preview }，請務必設定，填寫完整。 -->
<!---->
<!-- ??? quote "若訂單需分批出貨，可以繼續使用超商配送嗎？" -->
<!-- 	若訂單需分批出貨，需要注意超商配送的限制： -->
<!---->
