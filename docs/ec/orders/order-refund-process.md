...
當訂單完成退貨流程後，最終步驟即是將款項退還給消費者。系統會依據您的金流服務與消費者的支付方式，開始自動或手動退款流程。
{ .subtitle }
...
=== "企業版/PLUS 版"
    ...
    | **AFTEE** | ✓ | ✕ | 自動刷退至AFTEE帳戶 |
    | **虛擬 ATM<br>超商條碼<br>超商代碼<br>貨到付款** | ✕ | ✓ | 若會員並未提供帳戶資訊，需先行向會員索取 |
...
=== "一般版無 CYBERBIZ PAYMENTS"

    | 支付方式 | 金流商後台 | 自行匯款 | 備註 |
    | ------- | ---------- | ------- | --- |
    | **信用卡** | ✓ | ✕ | |
    | **虛擬 ATM<br>超商條碼<br>超商代碼<br>貨到付款** | ✕ | ✓ | 
    | **LINE Pay** | ✓ | ✕ | |
    | **PayPal** | ✓ | ✕ |  |
    | **街口支付** | ✓ | ✕ | | 
    | **iPASS 一卡通** | ✓ | ✕ | | 
...
=== "金流商後台"
    ...
    3. 前往金流商平台後台完成退款。
    4. 返回後台，勾選該筆訂單。
    5. 點擊右上方 **選擇操作** > 將付款狀態改為 **已退款** 或 **部分退款**。
