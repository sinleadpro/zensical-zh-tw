...
6.  [**組合品價差**](../references/order-report-fields.md#組合品價差){ title="訂單報表可用欄位" data-preview }（企業版專用）：

    - **組合品價差**：該子商品類型在組合品活動下，相較於單品原價銷售時的讓利總金額（以商品種類為單位）。
    - **組合品價差明細**：該子商品類型下的每一件商品，實際分攤到的讓利金額（以單件商品為單位）。
