...
permalink: https://help.cyberbiz.io/ec/orders/home-delivery/tcat-home-delivery
comments: false
search:
  exclude: false
icon: lucide/cat
...
於三大節日（端午、中秋、春節）物流繁盛期間，每張託運單將額外加收 10 Cyber幣 服務費。
...
- **溫層混配處理費**  
若 **列印常溫託運單卻以低溫寄送** ，或 **列印低溫託運單卻以常溫寄送** ，每張託運單將額外加收 **50 Cyber幣** 的處理費。
...
- [x] **設定公司物流地址**：進入 **金物流 > 黑貓託運單**，完成公司物流地址設定。

    ![](https://www.cyberbiz.io/support/wp-content/uploads/EC-後台-金物流-黑貓託運單-建立物流資訊01.png)
