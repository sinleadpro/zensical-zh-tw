...
!!! info "重要規範"
    ...
    | **自動化限制** | 部分出貨訂單 **不會自動結案**，需於全數出貨後[手動結案](../order-settings/manual-order-close.md){ data-preview }。 |
...
當您使用合作的第三方物流或自行配送時（詳細操作請參考[如何使用自訂物流出貨](custom-logistic-shipping.md){ data-preview }）：
