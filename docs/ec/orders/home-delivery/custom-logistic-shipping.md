...
![自訂物流出貨](../../../assets/images/EC-訂單-所有訂單-更多操作-已出貨-hero.png){ title="自訂物流出貨" .hero-page }
...
- [x] **配送方式**：為「宅配」超商取貨（包含已付款與取貨付款）及宅配貨到付款訂單 **不適用** 此流程，請改用對應物流流程。
...
適合一次將多筆訂單快速改為「已出貨」，不需逐筆填寫託運單號的情境。
...
3. **執行出貨**：點擊列表上方「更多操作」>「已出貨」。
    ...
    === "新版訂單列表"
        ...
        ![操作訂單為已出貨](../../../assets/images/EC-訂單-所有訂單-更多操作-已出貨.png){ title="操作訂單為已出貨" }

    === "舊版訂單列表"

        ![操作訂單為已出貨-舊版](../../../assets/images/EC-訂單-所有訂單-更多操作-已出貨-舊版.png){ title="操作訂單為已出貨-舊版" }
...
4. **選擇貨運公司**：於「請選擇貨運公司」視窗中選擇實際配合的物流商。
    ...
    === "新版訂單列表"
        ...
        ![選擇貨運公司](../../../assets/images/EC-訂單-所有訂單-更多操作-已出貨-選擇貨運公司.png){ title="選擇貨運公司" }

    === "舊版訂單列表"

        ![選擇貨運公司-舊版](../../../assets/images/EC-訂單-所有訂單-更多操作-已出貨-選擇貨運公司-舊版.png){ title="選擇貨運公司-舊版" }
...
### 大量匯入自訂物流託運單號 <small>Excel</small> { #excel-bulk-import }

適合需要 **一次回填多筆不同託運單號** 的情境。
...
2. **下載範本**：點擊「大量匯入自訂物流託運單號」，下載系統提供的 Excel 範本檔。
    ...
    ![大量匯入自訂物流託運單號](../../../assets/images/EC-訂單-所有訂單-大量匯入自訂物流託運單號.png){ title="大量匯入自訂物流託運單號" }
...
3. **填寫資料**：
    ...
    ![大量匯入自訂託運單範本](../../../assets/images/大量匯入自訂託運單範本.png){ title="大量匯入自訂託運單範本" }
...
![訂單詳情頁-自訂出貨](../../../assets/images/EC-訂單-訂單詳情頁-出貨方式-自訂出貨.png){ title="訂單詳情頁-自訂出貨" }

## 特殊情境處理

- **顧客自取**： 仍使用「自訂物流」流程，「快遞單號」可填寫自取編號或「顧客自取」等文字。
- **商家自送**：可直接使用 [批次出貨](#custom-logistics-shipping-batch)，並於備註補充交付資訊。
