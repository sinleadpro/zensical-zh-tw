...
last_modified: 2026-06-24 10:22
lang: zh-TW
type: tutorial
status: ""
version: ""
...
![LINE OA 樣板設定頁面](../../assets/images/ec-訊息推播-line oa 樣板.png){ .hero-page }
...
- [x] [**串接 Messaging API**](../integrations/line/account-integration/connect-line-messaging-api.md){ title="串接 LINE Messaging API" }  ：須先將您的 LINE 官方帳號與系統後台完成 API 串接。

- [x] **收集 LINE UID**：商家需開啟 **LINE 快速登入** 或引導會員操作 [**LINE OA 官方帳號綁定官網會員**](../integrations/line/account-integration/bind-line-oa-store-members.md){ title="綁定 LINE 官方帳號與官網會員" }  ，系統才能收集會員的 LINE UID 以發送訊息。
...
??? quote "為什麼顧客反映沒有收到 LINE 通知" 
	...
	1. **綁定狀態**：顧客是否已完成 [LINE OA 官方帳號綁定官網會員](../integrations/line/account-integration/bind-line-oa-store-members.md){ title="綁定 LINE 官方帳號與官網會員" }？系統必須取得 LINE UID 才能發送。 
