...
last_modified: 2026-08-28 17:30
lang: zh-TW
type: guide
author: Ann
reviewers: []
...
!!! warning "蝦皮平台商品填寫規範"
    為確保商品順利轉換，請務必確認所有欄位均符合 [欄位填寫規則](#欄位填寫規則)，以免匯入失敗。
...
4. 發佈成功後，商品將自動轉為 `已關聯`。您可進一步開啟 [庫存同步](step3-sync-inventory-with-shopee.md) 或[商品資訊同步](step5-sync-product-info-with-shopee.md)功能。
...
| **商品描述** | 圖片高度 > 32px<br>圖片寬度 > 700px<br>寬高比例介於0.5 ~ 3.2 之間<br>圖片大小不可超過 2MB<br>數量不可超過 12 張 | 
| **商品圖片** | 蝦皮商城：請上傳 3 ~ 9 張圖片<br>一般賣家：請上傳 1 ~ 9 張圖片<br>若超過此限制，系統將自動取前 9 張作為預設 | 
