...
- **前置作業**：使用此功能前，需先完成 [Chat Box 串接第三方平台 (LINE•Meta)](Chat Box 串接第三方平台 (LINE•Meta).md)。- **前置作業**：使用此功能前，需先完成 [Chat Box 串接第三方平台 (LINE•Meta)](Chat Box 串接第三方平台 (LINE•Meta).md)。
