...
last_modified: 2026-05-05 11:17
lang: zh-TW
type: tutorial
status: ""
version: 1.1.1
...
cyb_extensions: []
intents: ["識別會員身份", "查看會員標籤", "編輯會員資料"]
features: ["會員標籤", "門市助理"]
prerequisites: ["[[註冊與綁定官網會員]]"]
related: ["[[02-數據洞察：消費概況與會員權益分析]]", "[[03-成交引導：資產核銷與商品推薦工具]]"]
tags: ["門市助理", "精準識客", "會員標籤", "身份識別"]
acoiv: operation
apis: []
devices: ["tablet", "mobile"]
ui_components: ["會員資訊頁", "編輯圖示", "儲存變更", "會員標籤"]
paths: ["門市管理 > 角色與權限", "設定 > 功能設定 > 會員標籤", "會員 > 所有會員"]
layouts: []
wp_url: []
permalink: ""
comments: false
