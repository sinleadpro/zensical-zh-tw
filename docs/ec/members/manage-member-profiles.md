...
!!! info "擴充自訂資訊"
    ...
    - **自訂欄位**：檢視商家[自定義之註冊欄位](../website-management/customer-registration-flow-and-fields.md#步驟-4-建立與管理自訂欄位)，以及會員對應的填答內容。
      > 本功能僅支援 **高手 PLUS版 與企業版** 客戶使用。
...
捲動至 **其他通路累積金額**/**其他通路訂單** 區塊，此區塊旨在整合非系統串接平台（如：市集、私域社群導購）的消費貢獻，透過 **手動補入**，將零散的外站數據併入系統，完成會員全生命週期的資產管理。
...
=== "精確明細管理（高手、PLUS、企業）"
    ...
    -   **適用場景**：精確紀錄每筆站外訂單來源（如：台北快閃店、LINE 團購）以供對帳。
    ...
    -   **操作步驟**：
        ...
        !!! tip "企業版專屬欄位"
            企業版獨家支援 **備註** 欄位，此欄位資訊顯示於會員前台頁，商家可新增 **提醒資訊**、**出貨資訊**，供消費者辨識訂單來源。

            ![](../../assets/images/EC-前台-會員中心-其他通路訂單備註01.png)
