...
![](../../../assets/images/EC-後台-會員-VIP設定-與其他行銷活動的併用規則01.png){ .small-image }

!!! info "紅利點數啟用開關"
    若想贈送紅利點數，請先前往 **行銷活動 > 全館折扣-紅利 & 優惠券**，[開啟紅利點數功能](../../marketing/bonus-and-gifts/setup-bonus-points/#使用須知)。
...
2. 選擇生日禮類型（可全選）：
    ...
    === "贈品券"
        ...
        **使用條件**
        ...
        了解 [贈品券規格](../../marketing/coupon/gift-coupon-spec/#使用須知)。
