...
last_modified: 2026-06-25 15:09
lang: zh-TW
type: tutorial
status: ""
version: ""
...
!!! info "更多廣告列表欄位資訊"
    關於列表中各項指標（如 ROAS、CTR、頻率）的詳細定義與數據解讀，請參考 [廣告活動列表欄位說明](meta-ad-performance-analysis.md#廣告活動列表欄位說明){ title="使用 Meta 廣告成效分析" } 文檔。
...
- :lucide-wrench:{ .lg }   
  [__手動分享資產給 CYBERBIZ__](share-asset-permissions-cyberbiz.md){ title="手動分享資產權限給 CYBERBIZ" }       
