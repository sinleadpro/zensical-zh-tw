...
- [x] **商品影片上傳：** 商家必須已於 CYBERBIZ 後台完成[商品影片上傳](../../../products/create-and-manage/setup-product-videos.md){ title="設定商品影片" }。
- [x] **擴充套件串接：** 商家必須具備並已串接「[Facebook 新版商業擴充套件](../mbe/setup-fbe-authorization.md){ title="設定 FBE 帳號授權與資產連結" }」功能。
