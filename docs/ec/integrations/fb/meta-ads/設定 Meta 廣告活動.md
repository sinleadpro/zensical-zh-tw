...
2.  **新增活動**：點擊左側 **廣告活動 > 創建廣告活動**，於「活動目標設定」選擇「流量」或「銷售量」。
...
3.  **內容填寫**：設定「廣告活動名稱」、「每日預算」、「轉換價值」（銷售量）以及廣告的開始與結束時間。
    ...
    !!! tip "投放優化建議"
        建議初期設定較高預算以加速 AI 學習（目標每週 30–50 次轉換），詳見 [每日預算指南](設定 Meta 廣告每日預算.md){ data-preview }。
