...
last_modified: 2026-04-13 17:00
lang: zh-TW
type: tutorial
status: ""
author: Jase
...
3. **建立 Facebook/Instagram 商店** - 在商務管理工具中建立商店（詳細步驟請參閱 [Meta 官方教學 :lucide-external-link:](https://www.facebook.com/business/help/268860861184453)）

!!! note "官方文件提示"
    Meta 官方提供完整的商店建立教學，包含建立商務管理工具帳號、設定銷售管道及發佈商店的完整流程。建議先閱讀原廠文件了解整體架構，再依據下方章節進行 CYBERBIZ 串接設定。
