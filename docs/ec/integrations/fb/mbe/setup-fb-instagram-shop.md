...
!!! warning "設定指引與支援範圍"
    Facebook 系統介面與政策將不定期更新，本指南內容僅供參考，實際操作請以 Facebook 官方最新規範為主。針對第三方平台的進階設定或技術排除，請洽詢 Facebook 官方支援中心，CYBERBIZ 恕無法提供技術支援。

    相關說明可參閱 Meta 官方教學：[在 Facebook 和 Instagram 上設定商店 :lucide-external-link:](https://zh-tw.facebook.com/business/help/268860861184453)。

## 使用前提與限制

在開始串接 Facebook 與 Instagram 商店前，請先依序完成以下設定：

- [x] **[帳號授權與資產連結](setup-fbe-authorization.md){ title="設定 FBE 帳號授權與資產連結" }** - 將像素、粉絲專頁、目錄及廣告帳號等資產連結至 CYBERBIZ 後台
- [x] **[網域驗證](setup-fbe-domain-verification.md){ title="設定 FBE 網域驗證" }** - 完成網域驗證以設定 8 個彙總事件，確保廣告轉換數據準確
...
- :lucide-swatch-book:{ .lg }   
  [__商品色票設定__](../../../products/create-and-manage/product-swatches-variant-images-drag-drop.md){ title="設定商品色票與款式圖片-拖拉版型" }       
