...
description: 教您如何在 Facebook 企業管理平台中完成網域驗證，並設定事件追蹤。包括 DNS 驗證與中繼標籤驗證兩種方式，以及 HiNet、GoDaddy、Gandi 等各大網域廠商的設定教學。
...
教您如何在 Facebook 企業管理平台中完成網域驗證，並設定事件追蹤。包括 DNS 驗證與中繼標籤驗證兩種方式，以及 HiNet、GoDaddy、Gandi 等各大網域廠商的設定教學。{ .subtitle }
