...
4. 設定完成後，可至 **產品動態饋給連結** 查看結果。
	...
	![](../../assets/images/ec-product-dynamic-feedback-link.zh-tw.png)
...
> :lucide-asterisk: 含有 `贈品` 跟 `排除product feed` 標籤的商品亦不會出現在 Google 搜尋結果中。了解更多[排除標籤設定](../products/設定商品標籤#排除上傳至第三方平台標籤)。
...
- [排除特定商品上傳至 GMC](../products/設定商品標籤#排除上傳至第三方平台標籤)
