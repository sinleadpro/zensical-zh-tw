...
2.  **檢查商品資訊**：確保商品符合美安規範，否則 XML 饋給會產生錯誤：
    ...
    *   **圖片規範**：必須使用 **RGB 模式的 JPG 檔**。
    !!! info "欄位填寫設定，請參閱 [商品基本設定](../products/create-and-manage/新增單一商品.md) 或 [Excel 大量匯入商品](../products/bulk-operations/Excel 大量匯入商品.md)。"
...
瞭解 [如何將商品排除上傳至第三方平台](../products/categories-and-tags/管理商品標籤.md#排除上傳至第三方平台標籤){ data-preview }。
