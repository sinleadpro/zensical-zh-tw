...
完成設定後，您可以使用 **Google Tag Assistant**（Chrome 擴充功能或網頁版）來[檢測網站是否已成功安裝 GTM 代碼](verify-tracking-tag-installation.md){ title="使用 Google Tag Assistant 驗證追蹤代碼是否正確安裝" }。
