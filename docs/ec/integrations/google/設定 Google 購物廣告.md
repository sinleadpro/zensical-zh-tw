...
![](docs/assets/images/ec-integrations-gmc.zh-tw.png){ title="串接 GMC：第三方整合 > Google > Google Merchant Center" .hero-page }
...
> 可從 Google 提供的既有類別清單中選擇，無法自訂名稱或新增分類，目前無法批次套用。
    ...
    ![](docs/assets/images/ec-google-product-category.zh-tw.png)
...
![](docs/assets/images/ec-gmc-connect-google-ads.zh-tw.png)
