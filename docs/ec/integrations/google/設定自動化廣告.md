...
![](docs/assets/images/ec-automated-advertising-system.zh-tw.png){ title="自動化廣告系統：第三方整合 > 自動化廣告系統" .hero-page }
...
![](docs/assets/images/ec-google-ads.zh-tw.png)
...
![](docs/assets/images/ec-automated-advertising-system-google-ads-settings.zh-tw.png)
...
![](docs/assets/images/ec-automated-advertising-system-campaign-management.zh-tw.png)
...
![](docs/assets/images/ec-automated-advertising-system-ad-funds.zh-tw.png)

- 進行廣告金儲值。 
> :lucide-info: 首次儲值免服務費，第二次開始服務費為 5%。 
- 儲值後，發票將自動寄送到您留的電子信箱。
> 點選確認儲值後會跳出視窗提供資訊填寫。  
...
> 可以放一張純商品圖片在最後，並到 **第三方整合 > 谷歌 Google 設定** 中勾選 **使用商品最後一張圖片**，系統將會以這張圖片作為廣告使用。  
	...
	![](docs/assets/images/ec-gmc-product-image-choice.zh-tw.png)
...
![](docs/assets/images/ec-charts-advertising-analysis.zh-tw.png)
