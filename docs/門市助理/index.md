...
<br>
<big>__開始使用__</big>  
快速啟動門市助理，協助門市店員進行導購、會員經營、活動推廣與跨通路互動，提升整體門市轉換率與業績表現。  
<br>
[新手上路 :lucide-circle-arrow-right:](get-started.md)

![](../assets/images/storepal-hero.png)
...
=== "導購與互動"
	...
	-   :lucide-gift:{ .lg .middle } __促銷活動展示__
