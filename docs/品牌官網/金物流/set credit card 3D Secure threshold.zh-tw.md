...
- [x] 已[開通 **CYBERBIZ PAYMENTS**](apply%20for%20CYBERBIZ%20PAYMENTS.zh-tw.md){ data-preview }
- [x] 擁有後台金流設定權限
...
2. 在 CYBERBIZ PAYMENTS 欄位，點擊 **:material-file-document-edit-outline: 編輯**。
...
## 延伸閱讀
- [[apply for CYBERBIZ PAYMENTS.zh-tw]]
