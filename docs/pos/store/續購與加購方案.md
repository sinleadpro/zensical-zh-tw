...
last_modified: 2026-04-10 10:00
lang: zh-TW
type: tutorial
status: ""
version: 1.1.1
...
plans: []
cyb_extensions: []
intents: ["POS 續約", "加購 POS 子機", "查詢 POS 方案費用"]
features: ["續購與加購方案", "POS 子機管理"]
prerequisites: []
related: []
tags: ["POS 續約", "加購子機", "合約管理", "POS_方案"]
acoiv: operation
apis: []
devices: ["desktop"]
ui_components: ["續約與加購方案", "POS 列表", "續約", "加購子機"]
paths: ["POS 功能 > 續約與加購方案"]
layouts: []
wp_url: ["https://www.cyberbiz.io/support/?p=24441"]
permalink: ""
comments: false
search:
  exclude: false
