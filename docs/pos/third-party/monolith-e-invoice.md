...
??? quote "已有盟立帳號，想將系統商切換為 CYBERBIZ 該如何操作？"
    ...
    5. 即可依 [Posiflex 有線發票機](../hardware/posiflex-wired-invoice-printer.md) 安裝並下測試單。
...
- :lucide-printer:{ .lg }
  [__有線發票機安裝教學__](../hardware/posiflex-wired-invoice-printer.md)<br>
  完成盟立申請後，請依照此指南安裝硬體設備。

- :lucide-settings:{ .lg }
  [__開立 POS 混稅發票__](../check/mixed-tax-invoices.md)<br>
  若有免稅商品需求，請接續設定混稅功能。
