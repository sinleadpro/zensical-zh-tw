...
2. 由總倉管理員安排逆物流回收包裹。
    ...
    - [黑貓逆物流](../../ec/payments-and-logistics/設定與加印黑貓託運單.md#ezcat-shipping-note-reverse)
    - [宅配通逆物流](../../ec/payments-and-logistics/設定宅配通託運單.md#operate-pelican-shipping-reverse) 
    - [新竹物流逆物流](../../ec/payments-and-logistics/設定新竹物流託運單.md#operate-hct-setup-reverse) 
...
4. 申請退貨後，請依照後續指示將商品 **退回總倉** 或 **入門市庫存**。
    - 流程可參照 [訂單取消 - 包裹已到店（顧客尚未取貨）](../../ec/orders/store-pickup-orders.md#三包裹已到店顧客尚未取貨)。
