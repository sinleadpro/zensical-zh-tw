...
lang: zh-TW
permalink: https://help.cyberbiz.io/pos/orders/修改訂單明細頁「店長改價」的顯示名稱
type: tutorial
status: ""
version: ""
author: Jase
...
-   **恢復機制**：樣版編輯器具備「**查看之前版本**」功能， [回溯至先前版本](../../ec/website-appearance/code-customization/使用樣板編輯器恢復網頁代碼.md#操作步驟){ data-preview }。
