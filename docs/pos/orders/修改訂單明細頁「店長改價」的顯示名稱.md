...
[:lucide-bolt:{ title="適用功能" }](../../resources/conventions#適用功能){ title="圖示慣例" } | 一般版型
{ .doc-badge }
...
-   **恢復機制**：樣版編輯器具備「**查看之前版本**」功能， [回溯至先前版本](../../ec/website-appearance/code-customization/使用樣板編輯器恢復網頁代碼.md#操作步驟){ title="使用樣板編輯器恢復網頁代碼" }。
