...
!!! tip "權限配置參考指引"
    設定權限時，若不確定各功能對應的控制範疇，請參閱 [POS人員權限欄位參考表](POS人員權限欄位參考表.md)。您可以依此表對照系統內各項操作（如：退貨、折扣、刪單）的開通範圍，快速建立職位模板。
...
- :lucide-user-round-key:{ .lg }   
  [__人員權限欄位參考表__](../reference/人員權限欄位參考表.md){ title="人員權限欄位參考表" data-preview }     
  了解權限類型與系統功能對應關係。
