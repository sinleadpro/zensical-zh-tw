---
title: 員工帳號與權限管理
description: 透過建立標準化的「身分模板」並指派給對應的「員工帳號」，商家可以確保每位店員僅能操作其職務範圍內的功能。
...
# 員工權限與帳號管理
透過建立標準化的「身分模板」並指派給對應的「員工帳號」，商家可以確保每位 POS 店員僅能操作其職務範圍內的功能。
{ .subtitle }
...
- **單店店長制**：每一間 POS 商店僅能指派一位「店長」，其餘均為店員身分。
