...
- **軟體需求**：POS 主機需安裝 [POS APP 驅動程式](../software/drivers.md)，並開啟 POS APP。
...
1. 確保 POS 主機已下載並執行 [POS APP 驅動程式](../software/drivers.md)，點選 **點此開啟前台**。
...
- :lucide-banknote:{ .lg }   
[__建立 POS 互動遊戲__](../../ec/marketing/other-tools/interactive-games.md)     
設計 POS 專屬轉盤或抽獎活動。

- :lucide-banknote:{ .lg }   
[__建立訂單加價購活動__](../../ec/marketing/upsells/setup-order-upsell.md)     
預先規畫適用的加購品項與觸發門檻。
