...
- **發票規範**：刷卡機僅作為「印表機」使用，不含發票開立服務。商家必須購買 [盟立](../third-party/monolith-e-invoice.md) 發票服務方可開立發票。
...
??? quote "刷卡機可以刷 LINE Pay 嗎？"
    目前商米刷卡機僅支援實體信用卡支付。若需使用 LINE Pay，請參考 [POS LINE Pay 掃碼支付](../check/line-pay-scan-payment.md) 教學，使用掃碼槍作業。
