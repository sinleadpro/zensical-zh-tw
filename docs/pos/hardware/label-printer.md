...
- **硬體相容性預警**：若您使用非指定型號之現有設備，系統不保證可順利串接。
    ...
    > 建議配套：請先下載 [POS 專屬設備串接驅動程式](../software/drivers.md) 進行標籤列印測試，確認相容後再行使用。
...
3. **啟動驅動程式**：開啟電腦端的 [POS APP 驅動程式](../software/drivers.md)。
...
- :lucide-printer-check:{ .lg }   
  [__列印商品標籤__](../check/print-product-labels.md)     
  於後台進行列印測試。
