...
last_modified: 2026-03-25 16:10
lang: zh-TW
type: tutorial
status: ""
version: 1.1.1
author: Ann
reviewers: []
notes: ["內部連結：驅動程式、 POS 互動遊戲、訂單加價購"]
ga_views: 0
feedback: 0
products: [POS]
modules: ["所有 POS 商店"]
...
cyb_extensions: []
intents: ["如何設定_POS_客顯螢幕", "POS_廣告牆設定教學", "POS_加價購如何顯示在客顯", "解決客顯影片無法播放問題"]
features: ["POS_客戶顯示器", "廣告牆", "互動遊戲", "結帳加價購", "顧客資訊確認"]
prerequisites: []
related: []
tags: ["POS_客顯", "數位看板", "YouTube_版權排除", "門市行銷"]
acoiv: configure
apis: []
devices: [desktop]
ui_components: ["客顯行銷", "廣告牆設定", "同步客顯設定", "客顯行銷設定"]
paths: ["POS 功能 > 所有 POS 商店 > 選擇 POS 商店 > 客顯行銷頁籤"]
layouts: []
wp_url: ["https://www.cyberbiz.io/support/?p=5578"]
permalink: ""
comments: false
search:
  exclude: false
