...
2. 商家收到包裹並完成實體驗收後，請至訂單列表執行以下操作。
    ...
    - [執行退貨審查](../ec/orders/returns-refunds/訂單退貨流程/#步驟-2執行退貨審查){ title="訂單退貨流程" }
    - [執行退款流程](../ec/orders/returns-refunds/訂單退款流程.md){ title="訂單退款流程" }
...
- :lucide-chart-bar-increasing:{ .lg }   
  [__訂單退貨流程__](../ec/orders/returns-refunds/訂單退貨流程.md){ title="訂單退貨流程" }     
  了解系統退貨政策、操作須知與相關規則。

- :lucide-square-chart-gantt:{ .lg }   
  [__訂單退款流程__](../ec/orders/returns-refunds/訂單退款流程.md){ title="訂單退款流程" }     
