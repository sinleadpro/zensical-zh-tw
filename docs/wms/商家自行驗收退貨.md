...
plans: []
cyb_extensions: []
intents: ["設定自行退貨地址", "執行退貨審查", "處理人工退款"]
features: ["自行驗收", "退貨管理", "手動退款"]
prerequisites: ["需已開通 CYBERBIZ 電商倉儲服務", "僅限使用拖拉版型之商家", "需使用新版訂單列表介面"]
related: []
tags: ["自行退貨"]
acoiv: configure
apis: []
devices: ["desktop"]
ui_components: ["官網管理後台"]
paths: ["金物流 > 結帳頁&物流設定 > 訂單相關設定", "訂單 > 所有訂單"]
layouts: []
wp_url: ["https://www.cyberbiz.io/support/?p=4414"]
permalink:
comments: false
search:
  exclude: false
