...
5. **更新良品最短效期**：當商家更新商品 [良品最短效期](single-items/#新增單一品項){ data-preview } 欄位時。
...
- **超賣預防**：雖然系統有多重同步機制，但在極短時間內的高併發下單（如快閃活動）仍建議參考 [設定商品(現貨、限量、預購)](setup-products-stock-limit-preorder.md) 進行細緻化庫存管理。
