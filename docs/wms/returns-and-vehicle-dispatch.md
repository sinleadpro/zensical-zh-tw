...
- **特殊需求**：倉庫出貨的商品，預設寄回倉庫。若您希望倉庫出貨的商品，在退貨時直接寄回商家地址進行驗收，請參閱 [商家自行驗收退貨](merchant-self-inspection-of-returns.md)。
...
依據商家是否開啟 [官網前台的退貨功能](../ec/orders/member-return-request-feature.md)，採用的操作路徑如下：
...
| :--- | :--- | :--- | :--- |
| **全數商品收退** | 已驗收 | 已退貨 | 執行 [訂單退款作業](../ec/orders/order-refund-process.md) |
| **部分商品收退** | 部分驗收 | 部分退貨 | 執行 [訂單退款作業](../ec/orders/order-refund-process.md) |
...
4. **退款機制**：請依站台金流與訂單支付工具，查看訂單的 [退款方式](../ec/orders/order-refund-process.md)。
