...
- **異常修復**：若執行手動收貨後發現商品實際上未取件（如包裹遺失），須手動啟動 [退貨流程](../ec/orders/order-return-process.md)，以利執行 [倉庫驗退作業](returns-and-vehicle-dispatch.md#步驟二逆物流派車回收)、[訂單退款作業](../ec/orders/order-refund-process.md)。
