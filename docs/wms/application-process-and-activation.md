...
reviewers: []
notes:
  - 內部連結：大量填補SKU教學、建立單一品項、建立加工商品
  - 確認：宅配物流，結帳頁是串接物流與自訂物流並存？串接物流與自訂物流皆須設置？
ga_views: 0
feedback: 0
products:
  - WMS
...
![](../assets/images/EC-後台-金物流-宅配物流-串倉商家建立宅配物流01.png){ .screenshot }
...
- :lucide-square-arrow-right:{ .lg }   
  [__進倉作業規範__](merchant-inbound-operation-rules.md)     
